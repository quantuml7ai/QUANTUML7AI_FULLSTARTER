...
export function assessQl7SupportEmotionV11({ text = '', translatedText = '', tone = {}, messageAct = '' } = {}) {
...
export function applyQl7SupportEmotionalPresentationV11({ cardSpec = {}, text = '', translatedText = '', tone = {}, messageAct = '' } = {}) {
  const source = cardSpec && typeof cardSpec === 'object' ? cardSpec : {}
  const emotion = assessQl7SupportEmotionV11({ text, translatedText, tone, messageAct })
...
export function listQl7SupportEmotionFamiliesV11() {
