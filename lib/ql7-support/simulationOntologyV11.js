export const QL7_SUPPORT_SIMULATION_TOPICS_V11 = Object.freeze([
...
export const QL7_SUPPORT_CORE_NATIVE_LANGUAGES_V11 = Object.freeze(['en','ru','uk','es','tr','ar','zh','he'])
export const QL7_SUPPORT_SIMULATION_LANGUAGES_V11 = Object.freeze(['en','ru','uk','es','tr','ar','zh','he','de','fr','it','pt','pl','nl','sv','no','da','fi','cs','sk','hu','ro','bg','sr','hr','sl','el','ka','az','kk','ja','ko'])

export const QL7_SUPPORT_SIMULATION_AXES_V11 = Object.freeze({
...
export const QL7_SUPPORT_TOPIC_LABELS_V11 = Object.freeze({
...
export function getQl7SupportSimulationTopicLabelV11(topic = '') {
  return QL7_SUPPORT_TOPIC_LABELS_V11[str(topic)] || str(topic).replaceAll('_', ' ') || 'QL7 Support'
}

export function getQl7SupportSimulationSeedsV11(topic = '', locale = 'en', intent = '') {
  const id = str(topic)
  const lang = localeBase(locale)
  const label = getQl7SupportSimulationTopicLabelV11(id)
...
export function getQl7SupportSimulationLanguageFrameManifestV11() {
  return Object.freeze(Object.fromEntries(QL7_SUPPORT_SIMULATION_LANGUAGES_V11.map((locale) => [locale, { nativeCore: QL7_SUPPORT_CORE_NATIVE_LANGUAGES_V11.includes(locale), frameCount: Object.keys(FRAMES[locale] || FRAMES.en).length }])))
}
