import { fitQl7SupportReplyV11, QL7_SUPPORT_REPLY_MAX_GRAPHEMES_V11 } from './limitsV11.js'
...
const RAW_MACHINE_VALUE = Object.freeze([
  /\b(?:healthy|inconsistent|mongo_unavailable|provider_unavailable|no_source|source_present|foreign_account|timeout)\b/u,
...
export function applyQl7SupportAdultLanguagePolicy(value = '', {
  maxLength = QL7_SUPPORT_REPLY_MAX_GRAPHEMES_V11,
  ...
  return fitQl7SupportReplyV11(text, { maxGraphemes: Math.min(QL7_SUPPORT_REPLY_MAX_GRAPHEMES_V11, Math.max(1, Number(maxLength) || QL7_SUPPORT_REPLY_MAX_GRAPHEMES_V11)) }).text
}
...
export const QL7_SUPPORT_CORE_LOCALES_V6 = CORE_LOCALES
