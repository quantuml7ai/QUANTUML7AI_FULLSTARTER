...
export const QL7_SUPPORT_OBFUSCATION_MATCHER_VERSION = '15.1.1'

const ALL = Object.freeze({
  ...QL7_SUPPORT_NATIVE_SAFETY_LEXICON,
  ...QL7_SUPPORT_PROVIDER_SAFETY_LEXICON,
})
...
const THREAT_TERMS = Object.freeze({
  ...
  ru: Object.freeze(['атакую', 'взломаю', 'убью', 'уничтожу', 'взорву']),
  uk: Object.freeze(['атакую', 'зламаю', "вб'ю", 'знищу', 'підірву']),
  es: Object.freeze(['atacar', 'hackear', 'matar', 'destruir']),
  tr: Object.freeze(['saldır', 'hackle', 'öldür', 'yok et']),
  ar: Object.freeze(['أهاجم', 'أخترق', 'أقتل', 'أدمر', 'سأهاجم']),
  zh: Object.freeze(['攻击', '入侵', '杀', '摧毁']),
  he: Object.freeze(['אתקוף', 'אפרוץ', 'אהרוג', 'אשמיד']),
})
