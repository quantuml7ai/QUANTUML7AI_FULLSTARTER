...
export function getQl7NativeLocaleReadiness(locale='en'){const p=getQl7SupportLocaleProfile(locale);return Object.freeze({locale:p.locale,nativeModelRequired:false,deterministicJsRequired:true,languageBanksRequired:true,externalTranslationAllowed:false,semanticParityRequired:true,tokenizerCoverageRequired:false,blindNativeReviewRequired:true,profileVersion:QL7_SUPPORT_LOCALE_PROFILE_MANIFEST_VERSION})}
