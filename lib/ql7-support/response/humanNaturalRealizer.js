...
export const QL7_SUPPORT_HUMAN_NATURAL_REALIZER_VERSION = '18.0.0'
...
export function realizeQl7SupportHumanNaturalResponse({
  ...
  // Production realization is deliberately closed over reviewed JS banks, grammar,
  // ontology and deterministic selection. Model candidate adapters remain lab-only.
  const morphology = baseMorphology
