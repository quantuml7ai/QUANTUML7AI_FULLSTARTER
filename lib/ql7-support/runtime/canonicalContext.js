...
export const QL7_SUPPORT_CANONICAL_CONTEXT_VERSION = '18.0.0'
...
export async function buildQl7SupportCanonicalTurnContextAsync(input = {}, _dependencies = {}) {
  ...
  return Object.freeze({
    ...
    transition,
    conversationDecision,
    deterministicUnderstandingReceipt: semantic.deterministicUnderstandingReceipt || null,
    // Read-only compatibility alias for historical delivery receipts. It is not a model call.
    neuralUnderstandingReceipt: semantic.deterministicUnderstandingReceipt || null,
  })
}
