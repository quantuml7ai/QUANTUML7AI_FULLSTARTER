...
export function executeQl7SupportTurnRuntime(input = {}, adapters = {}) {
  ...
  // Production never emits self-training candidates. The local laboratory builds
  // candidates from redacted evidence outside this canonical executor.
  const learningIncident = null
