export const QL7_SUPPORT_SESSION_IDENTITY_CONTEXT_VERSION_V12 = '12.0.0'
...
export function buildQl7SupportSessionIdentityContextV12(seed = {}) {
  const actorSeed = str(seed.actorSeed || seed.userId || seed.walletAddress || 'ql7-support-v12-actor')
  const actorIdMasked = hashId(actorSeed)
  return Object.freeze({
    version: QL7_SUPPORT_SESSION_IDENTITY_CONTEXT_VERSION_V12,
...
export function assertQl7SupportNoRawIdentityRequestV12(text = '') {
