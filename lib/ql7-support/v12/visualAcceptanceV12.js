export const QL7_SUPPORT_VISUAL_ACCEPTANCE_VERSION_V12 = '12.0.0'

function str(value) { return String(value ?? '').trim() }

function hasRawEnglishSafetyBadgeV12(label = '', locale = 'en') {
...
export function serializeQl7SupportDomContractV12({ card = null, responseText = '', locale = 'en', viewport = 'virtual' } = {}) {
  ...
  return Object.freeze({
    version: QL7_SUPPORT_VISUAL_ACCEPTANCE_VERSION_V12,
    ...
    noRawBadgeEnglish: !badges.some((label) => hasRawEnglishSafetyBadgeV12(label, locale)),
