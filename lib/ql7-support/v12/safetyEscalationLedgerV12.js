export const QL7_SUPPORT_SAFETY_ESCALATION_LEDGER_VERSION_V12 = '12.0.0'

function str(value) { return String(value ?? '').trim() }

export function classifyQl7SupportSafetyEventV12({ tone = {}, text = '' } = {}) {
...
export function buildQl7SupportSafetyEscalationV12({ tone = {}, text = '', priorRudeCount = 0, nowMs = Date.now() } = {}) {
  const event = classifyQl7SupportSafetyEventV12({ tone, text })
  ...
  return Object.freeze({
    version: QL7_SUPPORT_SAFETY_ESCALATION_LEDGER_VERSION_V12,
    event,
    action,
