...
export const QL7_SUPPORT_ADS_READ_COLLECTIONS_V9 = Object.freeze(['ads_kv', 'ads_sets', 'ads_analytics', 'profile_aliases'])
...
export async function readQl7SupportAdsDiagnosticV9({
  database: _database,
  userId = '',
  aliases = [],
  analysis = {},
  ...
  return Object.freeze({
    ...
    businessCollectionsRead: QL7_SUPPORT_ADS_READ_COLLECTIONS_V9,
    ...
    evidence: Object.freeze({
      ...
      campaignRows,
      adapterId: 'ql7_support_ads_read_adapter_v9_same_source',
      sourceAdapter: 'adsCore.getAdsReadOnlySnapshot',
    }),
  })
}
