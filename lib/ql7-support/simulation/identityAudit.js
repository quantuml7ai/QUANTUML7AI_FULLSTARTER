...
function productionParity(snapshot = {}, pathName = 'wallet') {
...
export async function runQl7MongoIdentityAudit({
  ...
  const productionWallet = productionParity(walletSnapshot, 'wallet')
  const productionTelegram = productionParity(telegramSnapshot, 'telegram')
  const production = {
