...
// QL7_MONGO_PERMANENT_CODE_POLICY_V17
...
function getMongoPermanentPolicy() {
  ...
  return Object.freeze({
    ...
    note: 'Mongo is the permanent primary read/write source for migrated domains; Redis remains only for realtime pubsub, TTL cache, locks, sessions, rate limits, push runtime and short-lived dedupe. Dual-write, normal Redis fallback and Redis cleanup are code-disabled.',
  })
}
