...
// EMA выстроены
if (emaUp) push('ai_f_ema21_gt_ma50_on',   { ema21: E21, ema50: E50, ema200: E200 })
if (emaDn) push('ai_f_ema21_gt_ma50_off',  { ema21: E21, ema50: E50, ema200: E200 })
...
function fallback(){
  return {
    ...
    reasons:[{key:'data.not_enough', params:{}}]
  }
}
