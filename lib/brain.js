// lib/brain.js — Quantum Brain v5 (Hubble-tuned)
...
// маленький хелпер для рандома
const randInt = (n) => Math.floor(Math.random() * n)


// Варианты формулировок для одних и тех же признаков.
// Важно: базовый ключ (который у тебя уже переведён) всегда остаётся в списке.
const REASON_VARIANTS = {
  ...
  ai_f_ema21_gt_ma50_on: [
    'ai_f_ema21_gt_ma50_on',
    'ai_f_ema21_gt_ma50_on_v2',
    'ai_f_ema21_gt_ma50_on_v3',
    'ai_f_ema21_gt_ma50_on_v4',
    'ai_f_ema21_gt_ma50_on_v5',
  ],
  ai_f_ema21_gt_ma50_off: [
    'ai_f_ema21_gt_ma50_off',
    'ai_f_ema21_gt_ma50_off_v2',
    'ai_f_ema21_gt_ma50_off_v3',
    'ai_f_ema21_gt_ma50_off_v4',
    'ai_f_ema21_gt_ma50_off_v5',
  ],

  ai_f_ma50_gt_ma200_on: [
    'ai_f_ma50_gt_ma200_on',
    'ai_f_ma50_gt_ma200_on_v2',
    'ai_f_ma50_gt_ma200_on_v3',
    'ai_f_ma50_gt_ma200_on_v4',
    'ai_f_ma50_gt_ma200_on_v5',
  ],
  ai_f_ma50_gt_ma200_off: [
    'ai_f_ma50_gt_ma200_off',
    'ai_f_ma50_gt_ma200_off_v2',
    'ai_f_ma50_gt_ma200_off_v3',
    'ai_f_ma50_gt_ma200_off_v4',
    'ai_f_ma50_gt_ma200_off_v5',
  ],

  ai_f_price_gt_vwap_on: [
    'ai_f_price_gt_vwap_on',
    'ai_f_price_gt_vwap_on_v2',
    'ai_f_price_gt_vwap_on_v3',
    'ai_f_price_gt_vwap_on_v4',
    'ai_f_price_gt_vwap_on_v5',
  ],
  ai_f_price_gt_vwap_off: [
    'ai_f_price_gt_vwap_off',
    'ai_f_price_gt_vwap_off_v2',
    'ai_f_price_gt_vwap_off_v3',
    'ai_f_price_gt_vwap_off_v4',
    'ai_f_price_gt_vwap_off_v5',
  ],

  ai_f_rsi_overbought: [
    'ai_f_rsi_overbought',
    'ai_f_rsi_overbought_v2',
    'ai_f_rsi_overbought_v3',
    'ai_f_rsi_overbought_v4',
    'ai_f_rsi_overbought_v5',
  ],
  ai_f_rsi_oversold: [
    'ai_f_rsi_oversold',
    'ai_f_rsi_oversold_v2',
    'ai_f_rsi_oversold_v3',
    'ai_f_rsi_oversold_v4',
    'ai_f_rsi_oversold_v5',
  ],
  ai_f_rsi_bull_on: [
    'ai_f_rsi_bull_on',
    'ai_f_rsi_bull_on_v2',
  ...
  ai_f_rsi_bull_off: [
    'ai_f_rsi_bull_off',
    'ai_f_rsi_bull_off_v2',
    'ai_f_rsi_bull_off_v3',
    'ai_f_rsi_bull_off_v4',
    'ai_f_rsi_bull_off_v5',
  ],
  ...
  ai_f_macd_pos_off: [
    'ai_f_macd_pos_off',
    'ai_f_macd_pos_off_v2',
    'ai_f_macd_pos_off_v3',
    'ai_f_macd_pos_off_v4',
    'ai_f_macd_pos_off_v5',
  ],

  ai_f_breakout_long: [
    'ai_f_breakout_long',
    'ai_f_breakout_long_v2',
    'ai_f_breakout_long_v3',
    'ai_f_breakout_long_v4',
    'ai_f_breakout_long_v5',
  ],
  ai_f_breakdown_short: [
    'ai_f_breakdown_short',
    'ai_f_breakdown_short_v2',
    'ai_f_breakdown_short_v3',
    'ai_f_breakdown_short_v4',
    'ai_f_breakdown_short_v5',
  ],

  ai_f_bbands_squeeze: [
    'ai_f_bbands_squeeze',
    'ai_f_bbands_squeeze_v2',
    'ai_f_bbands_squeeze_v3',
    'ai_f_bbands_squeeze_v4',
    'ai_f_bbands_squeeze_v5',
  ],

  ai_f_stoch_overbought: [
    'ai_f_stoch_overbought',
    'ai_f_stoch_overbought_v2',
    'ai_f_stoch_overbought_v3',
    'ai_f_stoch_overbought_v4',
    'ai_f_stoch_overbought_v5',
  ],
  ai_f_stoch_oversold: [
    'ai_f_stoch_oversold',
    'ai_f_stoch_oversold_v2',
    'ai_f_stoch_oversold_v3',
    'ai_f_stoch_oversold_v4',
    'ai_f_stoch_oversold_v5',
  ],

  ai_f_adx_trending: [
    'ai_f_adx_trending',
    'ai_f_adx_trending_v2',
    'ai_f_adx_trending_v3',
    'ai_f_adx_trending_v4',
    'ai_f_adx_trending_v5',
  ],
  ai_f_adx_flat: [
    'ai_f_adx_flat',
    'ai_f_adx_flat_v2',
  ...
  ai_f_vola_explosive: [
    'ai_f_vola_explosive',
    'ai_f_vola_explosive_v2',
    'ai_f_vola_explosive_v3',
    'ai_f_vola_explosive_v4',
    'ai_f_vola_explosive_v5',
  ],
  ai_f_vola_low: [
    'ai_f_vola_low',
    'ai_f_vola_low_v2',
  ...
  ai_note_oversold_risk_reversal: [
    'ai_note_oversold_risk_reversal',
    'ai_note_oversold_risk_reversal_v2',
    'ai_note_oversold_risk_reversal_v3',
    'ai_note_oversold_risk_reversal_v4',
    'ai_note_oversold_risk_reversal_v5',
  ],
  ai_note_overbought_risk_reversal: [
    'ai_note_overbought_risk_reversal',
    'ai_note_overbought_risk_reversal_v2',
    'ai_note_overbought_risk_reversal_v3',
    'ai_note_overbought_risk_reversal_v4',
    'ai_note_overbought_risk_reversal_v5',
  ],

  ai_note_data_short_history: [
    'ai_note_data_short_history',
    'ai_note_data_short_history_v2',
    'ai_note_data_short_history_v3',
    'ai_note_data_short_history_v4',
    'ai_note_data_short_history_v5',
  ],
  ai_note_data_low_vola: [
    'ai_note_data_low_vola',
    'ai_note_data_low_vola_v2',
    'ai_note_data_low_vola_v3',
    'ai_note_data_low_vola_v4',
    'ai_note_data_low_vola_v5',
  ],
  ...
  ai_note_oi_change: [
    'ai_note_oi_change',
    'ai_note_oi_change_v2',
    'ai_note_oi_change_v3',
    'ai_note_oi_change_v4',
    'ai_note_oi_change_v5',
  ],
  ai_note_basis: [
    'ai_note_basis',
    'ai_note_basis_v2',
  ...
  ai_note_dominance: [
    'ai_note_dominance',
    'ai_note_dominance_v2',
    'ai_note_dominance_v3',
    'ai_note_dominance_v4',
    'ai_note_dominance_v5',
  ],
  ai_note_btc_corr: [
    'ai_note_btc_corr',
    'ai_note_btc_corr_v2',
  ...
  ai_note_global_spot: [
    'ai_note_global_spot',
    'ai_note_global_spot_v2',
    'ai_note_global_spot_v3',
    'ai_note_global_spot_v4',
    'ai_note_global_spot_v5',
  ],
  ai_note_venue_spread: [
    'ai_note_venue_spread',
    'ai_note_venue_spread_v2',
    'ai_note_venue_spread_v3',
    'ai_note_venue_spread_v4',
    'ai_note_venue_spread_v5',
  ],
}

// Ты можешь потом подредактировать формулировки как захочешь.
const REGIME_TEXT = {
  range: {
    ru: 'флэтовый рынок',
    uk: 'флетовий ринок',
    en: 'sideways / ranging market',
    es: 'mercado lateral (rango)',
    zh: '震荡区间市场',
    tr: 'yatay / bant piyasası',
    ar: 'سوق يتحرك في نطاق عرضي',
  },
  range_low_vol: {
    ru: 'флэт с низкой волатильностью',
    uk: 'флет з низькою волатильністю',
    en: 'range with low volatility',
    es: 'rango con baja volatilidad',
    zh: '低波动震荡区间',
    tr: 'düşük volatilite ile yatay piyasa',
    ar: 'نطاق عرضي مع تقلب منخفض',
  },
  range_high_vol: {
    ru: 'флэт с высокой волатильностью',
    uk: 'флет з високою волатильністю',
    en: 'range with high volatility',
    es: 'rango con alta volatilidad',
    zh: '高波动震荡区间',
    tr: 'yüksek volatilite ile yatay piyasa',
    ar: 'نطاق عرضي مع تقلب مرتفع',
  },
  bull_trend: {
    ru: 'бычий тренд',
    uk: 'бичачий тренд',
  ...
  bull_trend_low_vol: {
    ru: 'бычий тренд с низкой волатильностью',
    uk: 'бичачий тренд з низькою волатильністю',
    en: 'bull trend with low volatility',
    es: 'tendencia alcista con baja volatilidad',
    zh: '低波动多头趋势',
    tr: 'düşük volatilite ile boğa trendi',
    ar: 'اتجاه صعودي مع تقلب منخفض',
  },
  bull_trend_high_vol: {
    ru: 'бычий тренд с высокой волатильностью',
    uk: 'бичачий тренд з високою волатильністю',
    en: 'bull trend with high volatility',
    es: 'tendencia alcista con alta volatilidad',
    zh: '高波动多头趋势',
    tr: 'yüksek volatilite ile boğa trendi',
    ar: 'اتجاه صعودي مع تقلب مرتفع',
  },
  bear_trend: {
    ru: 'медвежий тренд',
    uk: 'ведмежий тренд',
  ...
  bear_trend_low_vol: {
    ru: 'медвежий тренд с низкой волатильностью',
    uk: 'ведмежий тренд з низькою волатильністю',
    en: 'bear trend with low volatility',
    es: 'tendencia bajista con baja volatilidad',
    zh: '低波动空头趋势',
    tr: 'düşük volatilite ile ayı trendi',
    ar: 'اتجاه هبوطي مع تقلب منخفض',
  },
  bear_trend_high_vol: {
    ru: 'медвежий тренд с высокой волатильностью',
    uk: 'ведмежий тренд з високою волатильністю',
    en: 'bear trend with high volatility',
    es: 'tendencia bajista con alta volatilidad',
    zh: '高波动空头趋势',
    tr: 'yüksek volatilite ile ayı trendi',
    ar: 'اتجاه هبوطي مع تقلب مرتفع',
  },
}
// -------------------------- base indicators --------------------------
function sma(a, n) {
...
export function analyzeTF(pack) {
  ...
  // старший ТФ — более сильный вес + сохраняем bias
  if (Number.isFinite(htfTrend)) {
    htfBias = clip(htfTrend, -3, 3)
    macroScore += htfBias * 1.0
  }

  if (Number.isFinite(htfRoc)) {
    macroScore += clip(htfRoc * 100, -5, 5) * 0.4
  }

  // venueSpread — усиливаем влияние и помечаем флаги риска
  if (Number.isFinite(venueSpread)) {
    const s = Math.abs(venueSpread)
    if (s > 0.015) {
      macroScore -= 1
      elevatedSpread = true
    }
  ...
  let action = 'HOLD'
  const TH = 2.8  // порог силы сигнала

  if (totalScore >= +TH) action = 'BUY'
  if (totalScore <= -TH) action = 'SELL'

  // Фильтр: не лезем против мощного HTF при слабом собственном сигнале
  const strongAgainst =
    (action === 'BUY'  && htfBias <= -1.0) ||
    (action === 'SELL' && htfBias >= +1.0)

  if (strongAgainst && absScore < TH + 1.2) {
    action = 'HOLD'
  }
  ...
  // слабый сигнал — режемconfidence
  const weakSignal = absScore < TH + 0.7
  if (action !== 'HOLD' && weakSignal) {
    confPenalty += 5
  }

  // флэт + низкая вола — не даём высокую уверенность
  const flatRegime =
    String(regime).includes('range') ||
    (Math.abs(trendScore) <= 2 && Math.abs(momentumScore) <= 2)

  if (action !== 'HOLD' && veryLowVola && flatRegime) {
    confPenalty += 6
  }

  // Spread риск — доп. штраф
  if (elevatedSpread) confPenalty += 6
  if (highSpread)     confPenalty += 10

  // ===== Entry / SL / TP (вход от отката, не по рынку) =====
  const rrNominal = 2.0
  let entry = null, sl = null, tp1 = null, tp2 = null
  const pullbackK = 0.35 // доля ATR для микропуллбека

  if (action === 'BUY') {
    const want = breakout20
      ? P - pullbackK * A              // после пробоя ждём откат
      : near.support + 0.2 * A        // от поддержки

    const base = Math.min(P, want)    // не покупаем выше текущей
    entry = base
  ...
  if (action === 'SELL') {
    const want = breakdown20
      ? P + pullbackK * A             // после пробоя ждём откат вверх
      : near.resistance - 0.2 * A

    const base = Math.max(P, want)    // не шортим ниже текущей
    entry = base
  ...
  // выбираем вариант ключа с учётом уже использованных в этом прогоне
  const pickVariantKey = (baseKey) => {
    const variants = REASON_VARIANTS[baseKey]
    if (!Array.isArray(variants) || variants.length === 0) return baseKey

    const fresh = variants.filter(k => !usedKeys.has(k))
  ...
  // единая точка входа: baseKey -> variantKey + params
  const push = (baseKey, params = {}, meta = {}) => {
    const key = pickVariantKey(baseKey)
    reasons.push({
      key,          // то, что реально пойдёт в словарь
      baseKey,      // исходный ключ (для отладки / аналитики, можно игнорить на фронте)
      params,
      ...meta,
    })
  }

  // режим рынка + немного цифр
  const atrPct = +(atrRel * 100).toFixed(1)

  // берём готовые переводы для текущего режима (или null, если вдруг нового режима нет в таблице)
  const regimeText = REGIME_TEXT[regime] || null

  push('ai_regime', {
    regime,      // технический код: "bull_trend_low_vol" и т.п.
    regimeText,  // объект с 7 языками: { ru, uk, en, es, zh, tr, ar } или null
    totalScore,
    trendScore,
    momentumScore,
    volaScore,
  ...
  // EMA / тренд
  if (emaAlignedUp)
    push('ai_f_ema21_gt_ma50_on', {
      ema21: E21,
      ema50: E50,
      ema200: E200,
    })
  else if (emaAlignedDn)
    push('ai_f_ema21_gt_ma50_off', {
      ema21: E21,
      ema50: E50,
      ema200: E200,
    })
  ...
  if (Number.isFinite(VWAP)) {
    if (P > VWAP) push('ai_f_price_gt_vwap_on',  { price: P, vwap: VWAP })
    else          push('ai_f_price_gt_vwap_off', { price: P, vwap: VWAP })
  }
  ...
  // MACD
  if (HIST > 0) push('ai_f_macd_pos_on',  { hist: HIST, macd: MACD, macdSignal: MACS })
  else          push('ai_f_macd_pos_off', { hist: HIST, macd: MACD, macdSignal: MACS })

  // breakout / breakdown
  if (breakout20)  push('ai_f_breakout_long',  { price: P })
  if (breakdown20) push('ai_f_breakdown_short', { price: P })

  // BB / squeeze
  if (Number.isFinite(BB_WIDTH)) {
    push('ai_f_bbands_width', { width: BB_WIDTH, bbMid: BB_MID })
  ...
  // stoch
  if (Number.isFinite(STO_K) && Number.isFinite(STO_D)) {
    if (STO_K > 80 && STO_D > 80)
      push('ai_f_stoch_overbought', { k: STO_K, d: STO_D })
    if (STO_K < 20 && STO_D < 20)
      push('ai_f_stoch_oversold',   { k: STO_K, d: STO_D })
  }
  ...
  if (atrRel > 0.035)
    push('ai_f_vola_explosive', { atrRel, atrPct })
  else if (atrRel < 0.004)
    push('ai_f_vola_low', { atrRel, atrPct })
  ...
  if (shortHistory)
    push('ai_note_data_short_history', { bars: N })
  if (veryLowVola)
    push('ai_note_data_low_vola', { atrRel, atrPct })

  if (Number.isFinite(rrEff)) {
    if (rrEff >= 2.0)
      push('ai_note_rr_good', { rr: rrEff, rrNominal })
    else if (rrEff <= 1.3)
      push('ai_note_rr_poor', { rr: rrEff, rrNominal })
  }
