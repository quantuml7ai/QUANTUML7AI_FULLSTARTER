...
const STYLE = `
.ql7SupportAuthPopoverLayer{position:fixed;inset:0;z-index:2147483000;display:grid;grid-template-columns:minmax(0,1fr);place-items:center;padding:18px;background:rgba(2,7,15,.62);backdrop-filter: none;overscroll-behavior:contain;touch-action:none}
...
.ql7RestrictionLayer{position:fixed;inset:0;z-index:2147483600;display:grid;place-items:center;padding:18px;background:rgba(2,7,15,.78);backdrop-filter: none;overscroll-behavior:contain;touch-action:none}
