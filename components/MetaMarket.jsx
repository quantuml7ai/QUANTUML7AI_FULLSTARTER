...
import { AvatarBadgeOverlay } from '../app/forum/features/profile/components/VipFlipBadge'
        ...
        <header className="mmHeader">
          ...
          {showContextStrip && <div className="mmContextStrip">
            {giftFlowActive && recipientState?.userId && (
              <span className="mmRecipientAvatar ql7AvatarBadgeHost">
                {recipientState?.icon || recipientState?.avatar ? (
                  <AvatarEmoji
                    userId={recipientState.userId}
                    pIcon={recipientState.icon || recipientState.avatar}
                    className="mmRecipientAvatarImg ql7AvatarMediaClip"
                  />
                ) : (
                  <span className="mmAnonymousAvatar ql7AvatarMediaClip" style={{ backgroundImage: `url("${ANONYMOUS_AVATAR_URL}")` }} aria-hidden="true" />
                )}
                <AvatarBadgeOverlay vipActive={!!recipientState?.vipActive} />
              </span>
            )}
          ...
          {stateStatus !== 'loading' && stateStatus !== 'error' && historyOpen && (
            <div className="mmHistoryPane">
              ...
              {historyStatus !== 'loading' && historyStatus !== 'error' && historyEvents.map((event) => {
                ...
                return (
                  <article key={event.txId} className={`mmHistoryRow mmHistory-${action}`} data-ql7-visual-scope="row">
                    ...
                    {counterparty?.userId ? (
                      ...
                      >
                        <span className="mmOwnerAvatar ql7AvatarBadgeHost">
                          {counterparty.icon || counterparty.avatar ? (
                            <AvatarEmoji
                              userId={counterparty.userId}
                              pIcon={counterparty.icon || counterparty.avatar}
                              className="mmOwnerAvatarImg ql7AvatarMediaClip"
                            />
                          ) : (
                            <span className="mmAnonymousAvatar ql7AvatarMediaClip" style={{ backgroundImage: `url("${ANONYMOUS_AVATAR_URL}")` }} aria-hidden="true" />
                          )}
                          <AvatarBadgeOverlay vipActive={!!counterparty.vipActive} showInfo />
                        </span>
          ...
          {stateStatus !== 'loading' && stateStatus !== 'error' && !historyOpen && mode === 'market' && !selectedCollectionId && !ownersItemId && (
            <div className="mmCollectionList">
              {marketCollections.length ? marketCollections.map((collectionLike) => {
                ...
                return (
                  <article key={collection.id} className={`mmCollectionCard mmTheme-${collection.theme || 'cyan'}`} data-ql7-visual-scope="card">
                    <button
                      type="button"
          ...
          {stateStatus !== 'loading' && stateStatus !== 'error' && !historyOpen && mode === 'market' && selectedCollectionId && !ownersItemId && (
            <div className="mmItemGrid">
              ...
              {collectionStatus !== 'loading' && collectionStatus !== 'error' && collectionItems.map((item) => {
                ...
                return (
                  <article key={canonical.itemId} className={`mmItemCard mmRarity-${canonical.rarity || 'common'}`} data-ql7-visual-scope="card">
                ...
                <div className="mmOwnersList">
                  {ownersUsers.map((user) => {
                    ...
                    return (
                      ...
                      >
                        <span className="mmOwnerAvatar avaMini ql7AvatarBadgeHost">
                          ...
                          <AvatarBadgeOverlay vipActive={!!user.vipActive} showInfo />
                        </span>
          ...
          {stateStatus !== 'loading' && stateStatus !== 'error' && !historyOpen && mode === 'collections' && (
            <div className="mmOwnedList">
              ...
              {ownedStatus !== 'loading' && ownedStatus !== 'error' && ownedItems.map((owned) => {
                ...
                return (
                  <article key={owned.itemId} className={`mmOwnedCard mmRarity-${canonical.rarity || 'common'} ${isNewGift ? 'isNewGift' : ''}`} data-ql7-visual-scope="card">
                  ...
                  <span className="mmTransactionAssetInfo">
                    ...
                    {transaction.action === 'gift' && recipientState?.userId && (
                      <span className="mmTransactionTarget">
                        <span className="mmTransactionTargetAvatar ql7AvatarBadgeHost">
                          {recipientState?.icon || recipientState?.avatar ? (
                            <AvatarEmoji
                              userId={recipientState.userId}
                              pIcon={recipientState.icon || recipientState.avatar}
                              className="mmTransactionTargetAvatarImg ql7AvatarMediaClip"
                            />
                          ) : (
                            <span className="mmAnonymousAvatar ql7AvatarMediaClip" style={{ backgroundImage: `url("${ANONYMOUS_AVATAR_URL}")` }} aria-hidden="true" />
                          )}
