...
/* =========================================================
   TIMING
========================================================= */
const FORUM_SPLASH_SHOW_MS = 10000           // 10000 = 10 seconds
const FORUM_SPLASH_CLOSE_ON_VIDEO_END = 0    // 1 = close when video ends, 0 = ignore video end
      ...
      >
        <div className="forum-boot-splash__frame">
          <video
            ...
            onEnded={() => {
              if (FORUM_SPLASH_CLOSE_ON_VIDEO_END === 1) finish()
            }}
          />
