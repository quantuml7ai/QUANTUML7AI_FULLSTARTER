  ...
  useEffect(() => {
    ...
    const verifyCurrentSession = async () => {
      ...
      try {
        ...
        // A watchdog success is only a liveness proof, not a new auth transition:
        // keep wallet-session:verified/qcoin:auth-ready, but do not republish auth:ok.
        await verifyStoredWalletSession({ emitAuthTransition: false })
      } finally {
