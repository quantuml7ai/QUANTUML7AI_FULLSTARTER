...
export default function PaymentMethodPopoverHost() {
  ...
  return createPortal(
    <>
      ...
      <style jsx global>{`
        .pmp-overlay{position:fixed;inset:0;z-index:2147482500;display:grid;place-items:center;padding:clamp(14px,3vw,34px);overflow:auto;background:radial-gradient(circle at 50% 40%,rgba(25,30,64,.5),rgba(2,4,12,.92) 68%);backdrop-filter: none;isolation:isolate}
