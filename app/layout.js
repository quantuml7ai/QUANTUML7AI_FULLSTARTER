...
import { buildMultilingualWebsiteStructuredData } from '../lib/seo/structuredData'
import QuantumOrganizationJsonLd from '../components/seo/QuantumOrganizationJsonLd'
import RootLocaleRuntime from '../components/seo/RootLocaleRuntime'
import PaymentMethodPopoverHost from '../components/PaymentMethodPopoverHost'
...
const MetaMarketHost = dynamic(() => import('../components/MetaMarketHost'), { ssr: false })
...
const AndroidNotificationBadgeSync = dynamic(() => import('../components/AndroidNotificationBadgeSync'), { ssr: false })
const AndroidAppPrompt = dynamic(() => import('../components/AndroidAppPrompt'), { ssr: false })
const Ql7SupportRuntimeBridge = dynamic(() => import('../components/Ql7SupportRuntimeBridge'), { ssr: false })
...
export const metadata = {
  ...
  verification: {
    google: 'kqwdLNLkj1d8JnC_RM37P2SA4O4PBlEB3IbobzZgxEc',
  },
  ...
  icons: {
    icon: withAssetVersion('/favicon.ico'),
    shortcut: withAssetVersion('/favicon.ico'),
      ...
      <head>
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify(buildMultilingualWebsiteStructuredData()),
          }}
        />
        <QuantumOrganizationJsonLd />
      ...
      <body>
        <Providers>
          <I18nProvider>
            ...
            <HeroAvatar />
            <AndroidNotificationBadgeSync />
            <AndroidAppPrompt />
            <Ql7SupportRuntimeBridge />
            <PaymentMethodPopoverHost />
