...
// Крупные/интерактивные штуки — только на клиенте
const HeroAvatar    = dynamic(() => import('../components/HeroAvatar'), { ssr: false })
const BgAudio       = dynamic(() => import('../components/BgAudio'),    { ssr: false })

// 🔹 Глобальная маркиза (клиентский виджет, использует тот же словарь, что и главная)
const GlobalMarquee = dynamic(() => import('../components/GlobalMarquee'), { ssr: false })
