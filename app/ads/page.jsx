...
function FooterIcons() {
  ...
  return (
    <div className="ql7-footer-social-layout"
      id="ads-footer-icons"
      data-ql7-render-managed="1" data-ql7-visual-scope="panel"
      data-ql7-visual-pause-js="1"
      style={{
        width: '100%',
        display: 'flex',
        alignItems: 'center',
    ...
    >
      <a className="ql7-footer-policy-link"
        href="/privacy"
      ...
      <a className="ql7-footer-support-link"
...
export default function AdsPage() {
  ...
  const handlePrimaryClick = async () => {
    ...
    try {
      ...
      const paymentMethod = await openPaymentMethodPopover({
        accountId: acc,
        purpose: 'ads',
  ...
  return (
    <div className="page-content" data-ql7-render-managed="1" data-ql7-visual-scope="route">
      <main className="page-center ads-landing">
        <section className="panel ads-landing-suite" data-ql7-render-managed="1" data-ql7-visual-scope="panel">
