...
export default function GamePage() {
  ...
  const metaStudioPortal = mounted && metaStudioOpen
    ? createPortal(
        <div className="metastudioOverlay" role="presentation" data-ql7-visual-scope="overlay">
          <section
  ...
  return (
    <>
      ...
      <main className="game-page-root" data-ql7-visual-scope="route">
        <section className="panel game-panel" data-ql7-visual-scope="panel">
