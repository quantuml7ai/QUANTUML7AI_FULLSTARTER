...
import TrustIdentityAboutTeaser from '../../components/trust/TrustIdentityAboutTeaser'
    ...
    <>
      <main className="container">
        <section className="panel">
          ...
          <TrustIdentityAboutTeaser content={t('trust_identity')} lang={lang} />
        ...
        <style jsx>{`
          ...
          .about-sections { width: 100%; margin-top: 1.25rem; }
