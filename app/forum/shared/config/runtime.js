...
export function readForumRuntimeConfig() {
  ...
  // Product invariant: every recommendation rail requests exactly 15 candidates.
  // Do not let stale env/window runtime config silently shrink the rail to 6/9/etc.
  const recommendationsBatchSize = DEFAULT_USER_RECOMMENDATIONS_BATCH_SIZE
