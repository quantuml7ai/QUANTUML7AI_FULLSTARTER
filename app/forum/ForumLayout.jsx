...
import ql7SupportGlobalStyles from './styles/modules/ql7SupportGlobalStyles'
...
export default function ForumLayout({
  ...
  useHeadStyle('ql7-support-global-styles', ql7SupportGlobalStyles)
  return (
    <div
      className="forum_root space-y-4"
      data-ql7-visual-scope="forum"
