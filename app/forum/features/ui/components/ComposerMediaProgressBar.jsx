...
export default function ComposerMediaProgressBar({
  ...
  const labels = React.useMemo(() => ({
    ...
    verifying: t?.('forum_media_moderating') || t?.('media_pipeline_verifying') || 'Moderating',
    prepared: t?.('media_pipeline_ready') || formatMediaPhase?.('Ready') || t?.('forum_media_ready') || 'Ready to send',
