...
export default function ThreadForumActionCluster({
  t,
  openInboxGlobal,
  inboxOpen,
  mounted,
  ...
  return (
    <>
      <ForumActionRow
        t={t}
        inboxButtonId="inbox_btn_thread"
        onInboxClick={() => openInboxGlobal('inbox_btn_thread')}
        inboxOpen={inboxOpen}
        mounted={mounted}
        ...
        videoFeedButtonId="video_feed_btn_thread"
        onVideoFeedClick={() => {
          if (videoFeedOpen) {
