...
// DM realtime is event-driven; periodic polling is only a slow safety fallback.
const DM_ACTIVE_THROTTLE_MS = 3 * 60 * 1000
const DM_BG_THROTTLE_MS = 5 * 60 * 1000
...
export default function useForumViewState() {
  ...
  const [topicSort, setTopicSort] = React.useState('random')
