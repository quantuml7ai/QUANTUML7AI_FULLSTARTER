export function buildModerationFormData(blobs, meta = {}) {
  ...
  if (meta?.surface) fd.append('surface', String(meta.surface))
  if (meta?.entityId) fd.append('entityId', String(meta.entityId))
  if (meta?.mediaUrl) fd.append('mediaUrl', String(meta.mediaUrl))
  return fd
}
