...
export default function usePostFx({ cardRef, rearmPooledFxNode }) {
  // G6: five-particle bursts do not need eighteen permanently mounted DOM nodes per card.
  // Ten preserves overlap headroom while cutting idle/detached FX DOM almost in half.
  const FX_POOL = 10
