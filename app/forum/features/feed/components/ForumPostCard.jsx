...
export default function ForumPostCard({
  ...
  useRenderManagedScope(cardRef, { kind: 'card', marginProfile: 'near100', initialNear: true })
    ...
    >
      ...
      <div className="postBodyFrame">
        ...
        <PostMediaStack
          ...
          videoModerationStatus={p?.videoModerationStatus}
          YT_RE={YT_RE}
      ...
      <div className="postBodyFrame">
        <PostBodyContent
          ...
          translationAnimationKey={translationAnimationKey}
          translationAnimationEnabled={translationAnimationEnabled}
