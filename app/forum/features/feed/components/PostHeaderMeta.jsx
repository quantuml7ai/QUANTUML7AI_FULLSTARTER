...
export default function PostHeaderMeta({
  ...
  const userPreview = {
    ...
    icon: resolveIconForDisplay(authorId, p?.icon),
    avatar: resolveIconForDisplay(authorId, p?.icon),
    vipActive: !!isVipAuthor,
    sourceKind: 'post-header',
  ...
  return (
    <>
      <div className="postUserRow mb-2">
        ...
        >
          <ForumNickText className="nick-text truncate" textValue={displayNickname}>{displayNickname}</ForumNickText>
        </button>
