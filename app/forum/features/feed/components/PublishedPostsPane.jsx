      ...
      {!showInitialPublishedSkeleton && publishedHasMore && (
        <div className="loadMoreFooter">
          ...
          <LoadMoreSentinel
            ...
            onVisible={() => {
              // QL7_GEO111_PUBLISHED_POSTS_LOAD_MORE_SERVER_V1
              if (!publishedServerLoading && typeof loadPublishedPostsPage === 'function') {
                loadPublishedPostsPage()
              }
              setVisiblePublishedCount((c) => c + publishedPageSize)
            }}
          />
        </div>
      )}
