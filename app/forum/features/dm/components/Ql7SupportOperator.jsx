...
import {
  QL7_SUPPORT_OPERATOR_STATES,
  QL7_SUPPORT_OPERATOR_STATIC_STATES,
  QL7_SUPPORT_OPERATOR_VIDEO_STATES,
...
const ACTIVE_STATES = new Set(QL7_SUPPORT_OPERATOR_VIDEO_STATES)
const INPUT_LOCK_CONTRACT = 'user-send-until-answer-commit'
const TERMINAL_STATES = new Set(['answer_ready'])
const STATIC_STATES = new Set(QL7_SUPPORT_OPERATOR_STATIC_STATES)
...
export default function Ql7SupportOperator({
  ...
  return h(
    'div',
    {
      ...
      'data-ql7-operator-video-states': QL7_SUPPORT_OPERATOR_VIDEO_STATES.join(' '),
      'data-ql7-operator-static-states': QL7_SUPPORT_OPERATOR_STATIC_STATES.join(' '),
