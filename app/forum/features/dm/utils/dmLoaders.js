...
export async function loadDmThread(withUserId, cursor = null, opts = {}, ctx = {}) {
  ...
  if (dmThreadLoadingRef.current && dmThreadLoadingRef.current === uid) return
  ...
  dmThreadLoadingRef.current = uid
  ...
  try {
    ...
    if (dmThreadLoadingRef.current === uid) dmThreadLoadingRef.current = false
