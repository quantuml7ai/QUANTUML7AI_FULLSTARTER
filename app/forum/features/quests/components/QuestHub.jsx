...
export default function QuestHub({
        ...
        {quests.map((q) => {
          ...
          return (
            <button
              key={q.id}
              type="button"
              className="item qshine questItem hoverPop text-left" data-ql7-visual-scope="card"
  ...
  return (
    <div className="item qshine" data-ql7-visual-scope="panel">
      {tickStyles}
      ...
      <div className="questTaskList">
        {taskList.map((task, idx) => {
          ...
          return (
            <div key={task.id ?? `t:${idx}`} className="item qshine questTask" data-ql7-visual-scope="row" data-intensity="soft">
