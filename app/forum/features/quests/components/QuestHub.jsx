...
function QuestCoverImage({ src, className = 'questThumb', width = 60, height = 60 }) {
  if (/\.gif(?:$|[?#])/i.test(String(src || ''))) {
    return <ViewportAnimatedImage animatedSrc={src} alt="" className={className} width={width} height={height} loading="lazy" decoding="async" />
  }
  return <Image className={className} src={src} alt="" loading="lazy" unoptimized width={width} height={height} />
}
...
export default function QuestHub({
        ...
        {quests.map((q) => {
          ...
          return (
            <button
              key={q.id}
              type="button"
              className="item qshine questItem hoverPop text-left" data-ql7-render-managed="1" data-ql7-visual-scope="card"
  ...
  return (
    <div className="item qshine" data-ql7-render-managed="1" data-ql7-visual-scope="panel">
      {tickStyles}
      ...
      <div className="questTaskList">
        {taskList.map((task, idx) => {
          ...
          return (
            <div key={task.id ?? `t:${idx}`} className="item qshine questTask" data-ql7-render-managed="1" data-ql7-visual-scope="row" data-intensity="soft">
