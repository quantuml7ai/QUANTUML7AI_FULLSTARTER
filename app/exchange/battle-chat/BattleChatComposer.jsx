...
import { BATTLE_CHAT_QUICK_EMOJIS } from './battleChatClient.js'
...
import useComposerSafetyPreview from '../../forum/features/ui/hooks/useComposerSafetyPreview.js'
...
export default function BattleChatComposer({ t, disabled, sending, onSend, locale='en' }) {
  ...
  const composerSafetyLocale = locale || (typeof document !== 'undefined' ? (document.documentElement?.lang || 'en') : 'en')
  const composerSafetyPreview = useComposerSafetyPreview(text, { enabled: true, locale: composerSafetyLocale, targeted: true, surface: 'battle_chat' })
  ...
  return (
    <form className={styles.composer} onSubmit={submit}>
      <ComposerSafetyBadge preview={composerSafetyPreview} locale={composerSafetyLocale} />
