...
import { useI18n } from '../../../components/i18n.js'
import { BATTLE_CHAT_FOLLOW_TAIL_THRESHOLD_PX } from './battleChatClient.js'
import { battleChatErrorKey } from './battleChatFormatters.js'
import BattleChatComposer from './BattleChatComposer.jsx'
import BattleChatMessageRow from './BattleChatMessageRow.jsx'
import { useBattleChat } from './useBattleChat.js'
...
export default function BattleChat() {
  ...
  return (
    <section id="ql7-exchange-battle-chat" className="battlecoin-card battle-chat-card" data-ql7-render-managed="1" data-ql7-visual-scope="panel">
