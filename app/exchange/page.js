...
function Panel({children}){
  return <div className="panel" data-ql7-visual-scope="panel">{children}
    <style jsx>{`
      ...
      <div className="ob-cols">
        ...
        <div className="ob-col">
          {bids.slice(0, 20).map((r, i) => (
            <div key={'b' + i} className="ob-row ob-row-bid" data-ql7-visual-scope="row">
              <div
        ...
        <div className="ob-col">
          {asks
            ...
            .reverse()
            .map((r, i) => (
              <div key={'a' + i} className="ob-row ob-row-ask" data-ql7-visual-scope="row">
                <div
                  className="ob-row-fill"
                  style={{ width: `${(r.qty / maxQty) * 100}%` }}
                />
