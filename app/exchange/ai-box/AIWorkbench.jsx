...
import { useTypewriterText } from '../../../components/visual-runtime/TypewriterText'
...
export default function AIWorkbench({
  ...
  useRenderManagedScope(workbenchRef, { kind: 'panel', marginProfile: 'near100', initialNear: true })
 ...
 const typedReasons = useTypewriterText(
  reasonsFullText,
  canAnalyze,
  42,
  15,
...
useEffect(() => {
  ...
  return (
    <section id="ql7-exchange-ai-box" className="ai-workbench" ref={workbenchRef} data-ai-workbench="v3" data-ql7-visual-scope="panel" data-ql7-render-managed="1">
