...
function useTypewriter(text, enabled, speed = 14, charsPerTick = 1) {
  ...
  }, [charsPerTick, enabled, speed, text])
...
useEffect(() => {
  ...
  return (
    <section id="ql7-exchange-ai-box" className="ai-workbench" ref={workbenchRef} data-ai-workbench="v3">
