...
const handleOpenQuantumWallet = () => {
  ...
  blocks.forEach((b, idx) => {
    content.push(
      ...
      <section className="panel" key={`b-${idx}`} data-ql7-visual-scope="panel">
  ...
  return (
    <div className="center-wrap" data-ql7-visual-scope="route">
...
/>
      ...
      <section className="panel" key="live-bloomberg" data-ql7-visual-scope="panel">
        <CryptoNewsLens />
      ...
      <div className="icons-row ql7-footer-social-layout" data-ql7-visual-scope="panel">
        <Link
          href="/privacy"
