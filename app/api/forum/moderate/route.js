...
// dependencies are loaded only for post-commit video moderation or public Ads status polling.
...
async function getVideoDeps() {
  if (!videoDepsPromise) {
    ...
    ]).then(([forumPrimaryMod, dmPrimaryMod, identity, forumDb, adsCore, forumBus, notificationCenter, webPush]) => ({
...
export async function POST(req) {
  ...
  try {
    ...
    if (source === VIDEO_POSTCOMMIT_SOURCE) {
