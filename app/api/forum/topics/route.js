// app/api/forum/topics/route.js
// БОЕВАЯ (alias): список тем (эквивалент /api/forum/listTopics)
// Контракт: GET ?page=&limit=&sort=&q= -> {items:[...], total}
...
export async function GET(req) {
  try {
    ...
    // для новых/популярных — убывающий порядок
