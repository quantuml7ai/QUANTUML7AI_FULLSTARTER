...
export async function writeQcoinBalanceMicro(userId, balanceMicro, options = {}) {
  return metamarketPrimary.writeQcoinBalanceMicro(userId, balanceMicro, options)
}
...
export async function ensureItemStates(items) {
  return metamarketPrimary.ensureItemStates(items)
}
...
export async function getUserItemCounts(userId, itemIds) {
  return metamarketPrimary.getUserItemCounts(userId, itemIds)
}
