...
import { clampLimit, errorCode, errorStatus, jsonError, jsonOk, microToQcoin, publicErrorCode } from '../_format.js'
...
export async function GET(req) {
  try {
    ...
    console.error('metamarket_token_history_failed', { code: errorCode(error) })
