...
function normalizeAddress(value) {
  return canonicalUserId.normalizeWalletId(value)
}
...
function notifyQl7WelcomeAfterCreate(payload) {
  if (String(process.env.SUPPORT_ACTIVE || '').trim() !== '1') return
  void import('../../../lib/ql7-support/events.js')
    .then(({ notifyQl7Welcome }) => notifyQl7Welcome(payload))
    .catch((error) => {
