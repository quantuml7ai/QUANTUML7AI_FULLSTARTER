...
Сгенерировано автоматически: 2026-08-07T06:36:48.135Z
Исходных файлов в анализе: 1034
Route-aware файлов: 154
...
- `lib/mongo/profile-primary.cjs` — используют 26 локальных модулей
...
- `lib/subscriptions.js` — используют 15 локальных модулей
...
- `lib/ql7-support/featureFlag.js` — используют 12 локальных модулей
- `lib/ql7-support/semanticRouter.js` — используют 12 локальных модулей
...
- `app/layout.js` — импортирует 17 локальных модулей
...
- `app/forum/features/ui/components/ForumSearchSortControls.jsx` — импортирует 11 локальных модулей
...
- `lib/ql7-support/localDictionaryContext.js` — импортирует 9 локальных модулей
- `lib/ql7-support/naturalLanguageRealizer.js` — импортирует 9 локальных модулей

## Зоны С Повышенной Плотностью Связей

- `app/layout.js` — файлов: 1; исходящих связей: 17; плотность: 17
- `forum/root` — файлов: 14; исходящих связей: 97; плотность: 6.93
- `api/dm` — файлов: 14; исходящих связей: 74; плотность: 5.29
...
- `forum/dm` — файлов: 40; исходящих связей: 105; плотность: 2.63
- `forum/subscriptions` — файлов: 4; исходящих связей: 10; плотность: 2.5
- `root` — файлов: 156; исходящих связей: 386; плотность: 2.47
- `api/forum` — файлов: 43; исходящих связей: 104; плотность: 2.42
- `app/exchange` — файлов: 12; исходящих связей: 27; плотность: 2.25
- `api/battlecoin` — файлов: 5; исходящих связей: 11; плотность: 2.2
- `lib/ql7-support` — файлов: 168; исходящих связей: 365; плотность: 2.17
- `forum/profile` — файлов: 18; исходящих связей: 36; плотность: 2
- `app/academy` — файлов: 3; исходящих связей: 6; плотность: 2
- `app/about` — файлов: 2; исходящих связей: 4; плотность: 2
