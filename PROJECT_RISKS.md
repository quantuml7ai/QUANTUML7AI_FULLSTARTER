...
Сгенерировано автоматически: 2026-09-15T18:42:50.699Z
...
- `lib/ql7-support/internal/text.js` — используют 136 локальных модулей
...
- `lib/ql7-support/config/behaviorManifest.js` — используют 30 локальных модулей
...
- `tests/support/projectSurface.js` — используют 17 локальных модулей
...
- `lib/ql7-support/server.js` — импортирует 40 локальных модулей
...
- `lib/ql7-support/runtime/executeTurn.js` — импортирует 32 локальных модулей
...
- `app/components` — файлов: 1; исходящих связей: 3; плотность: 3
...
- `api/forum` — файлов: 43; исходящих связей: 126; плотность: 2.93
- `forum/dm` — файлов: 42; исходящих связей: 118; плотность: 2.81
