...
Сгенерировано автоматически: 2026-09-05T14:07:03.331Z
...
- `app/api/account-restrictions/status/route.js` — Изменение влияет на серверный контракт и клиентов, завязанных на endpoint.
...
- `app/api/composer-safety/preview/route.js` — Изменение влияет на серверный контракт и клиентов, завязанных на endpoint.
...
- `app/api/dm/support-broadcast/route.js` — Изменение влияет на серверный контракт и клиентов, завязанных на endpoint.
...
- `app/api/dm/support-learning-consent/route.js` — Изменение влияет на серверный контракт и клиентов, завязанных на endpoint.
...
- `app/api/pay/qcoin-purchase/route.js` — Изменение влияет на серверный контракт и клиентов, завязанных на endpoint.
...
- `lib/ql7-support/internal/text.js` — используют 134 локальных модулей
- `lib/mongo/client.cjs` — используют 47 локальных модулей
- `app/api/forum/_utils.js` — используют 44 локальных модулей
- `components/i18n.js` — используют 41 локальных модулей
- `lib/ql7-support/ecosystemCatalog.js` — используют 38 локальных модулей
- `lib/ql7-support/language/locales/profileFactory.js` — используют 33 локальных модулей
- `app/api/profile/_identity.js` — используют 31 локальных модулей
- `lib/mongo/profile-primary.cjs` — используют 31 локальных модулей
- `lib/ql7-support/config/behaviorManifest.js` — используют 28 локальных модулей
- `tools/runtime-governance.js` — используют 25 локальных модулей
- `app/api/forum/_db.js` — используют 23 локальных модулей
- `lib/ql7-support/config/featureFlag.js` — используют 23 локальных модулей
- `lib/identity/canonical-user-id.cjs` — используют 21 локальных модулей
- `lib/ql7-support/systemActor.js` — используют 21 локальных модулей
...
- `lib/ql7-support/runtime/executeTurn.js` — используют 18 локальных модулей
...
- `lib/ql7-support/ontology/domains/index.js` — импортирует 46 локальных модулей
- `lib/ql7-support/server.js` — импортирует 41 локальных модулей
- `lib/ql7-support/simulation/lab/scientificLabContract.js` — импортирует 34 локальных модулей
- `lib/ql7-support/language/locales/manifest.js` — импортирует 33 локальных модулей
- `lib/ql7-support/runtime/executeTurn.js` — импортирует 33 локальных модулей
- `lib/composer-safety/reviewedMaterialRegistry.cjs` — импортирует 32 локальных модулей
- `lib/ql7-support/semantics/analyzeTurn.js` — импортирует 29 локальных модулей
- `tests/unit/ql7-support/final-runtime.test.js` — импортирует 28 локальных модулей
- `app/layout.js` — импортирует 21 локальных модулей
...
- `app/forum/features/dm/hooks/useForumDmRuntime.js` — импортирует 19 локальных модулей
- `tests/unit/ql7-support/premium-cognitive.test.js` — импортирует 19 локальных модулей
- `app/forum/features/dm/components/DmThreadMessageRow.jsx` — импортирует 18 локальных модулей
...
- `app/layout.js` — файлов: 1; исходящих связей: 21; плотность: 21
...
- `api/referral` — файлов: 2; исходящих связей: 11; плотность: 5.5
- `api/academy` — файлов: 1; исходящих связей: 5; плотность: 5
- `app/[lang]` — файлов: 1; исходящих связей: 5; плотность: 5
- `app/page.js` — файлов: 1; исходящих связей: 5; плотность: 5
- `app/ads` — файлов: 5; исходящих связей: 24; плотность: 4.8
- `api/pay` — файлов: 3; исходящих связей: 12; плотность: 4
- `api/ads` — файлов: 1; исходящих связей: 4; плотность: 4
...
- `api/metastudio` — файлов: 1; исходящих связей: 3; плотность: 3
...
- `lib/supportEmailTransport.js` — файлов: 1; исходящих связей: 3; плотность: 3
- `api/profile` — файлов: 10; исходящих связей: 29; плотность: 2.9
- `api/forum` — файлов: 43; исходящих связей: 124; плотность: 2.88
- `app/exchange` — файлов: 12; исходящих связей: 34; плотность: 2.83
- `api/battlecoin` — файлов: 5; исходящих связей: 14; плотность: 2.8
- `forum/dm` — файлов: 42; исходящих связей: 113; плотность: 2.69

## Серверные И Инфраструктурные Хотспоты

- `app/api/_diag/route.js`
- `app/api/academy/exam/route.js`
- `app/api/account-restrictions/status/route.js`
...
- `app/api/composer-safety/preview/route.js`
...
- `app/api/pay/qcoin-purchase/route.js`
...
- `lib/migrations/forumRulesStorage.js`
- `lib/ql7-support/ontology/domains/forum_feed.js`
- `lib/ql7-support/ontology/domains/forum_threads.js`
- `lib/ql7-support/ontology/domains/geodetect.js`
- `lib/ql7-support/ontology/domains/wallet.js`
- `lib/redis.js`
