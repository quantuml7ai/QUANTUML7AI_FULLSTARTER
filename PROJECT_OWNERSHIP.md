...
Сгенерировано автоматически: 2026-09-15T18:42:48.572Z
...
- Зона: `public/status`
- Назначение: Статические ассеты namespace status.
- Точки входа: `public/status/official.png`
- Связанные зоны: `app`, `components`, `app/forum`, `styles/public URLs`
...
- Зона: `public/youtube`
- Назначение: Статические ассеты namespace youtube.
- Точки входа: `public/youtube/play.webp`
- Связанные зоны: `app`, `components`, `app/forum`, `styles/public URLs`
