...
- Точки входа: `components/AuthNavClient.jsx`, `components/BgAudio.js`, `components/ForumBootSplash.jsx`, `components/ForumShellGate.jsx`, `components/HeroAvatar.js`, `components/HeroSection.js`, `components/i18n-dicts/ar.js`, `components/i18n-dicts/en.js`, `components/i18n-dicts/es.js`, `components/i18n-dicts/manifest.js`, `components/i18n-dicts/ru.js`, `components/i18n-dicts/tr.js`
