...
Сгенерировано автоматически: 2026-05-13T12:49:10.717Z
Исходных файлов в анализе: 822
Локальных зависимостей: 766
...
- `forum/media` -> `forum/media` — 25 локальных импортов
- `root` -> `src/shared` — 25 локальных импортов
- `components` -> `components` — 24 локальных импортов
...
- `api/forum` -> `api/profile` — 11 локальных импортов
- `forum/media` -> `forum/shared` — 11 локальных импортов
- `app/layout.js` -> `components` — 10 локальных импортов
...
- `forum/subscriptions` -> `forum/shared` — 5 локальных импортов
...
- `forum/ui` -> `forum/shared` — 4 локальных импортов
...
- `forum/profile` -> `forum/subscriptions` — 3 локальных импортов
- `forum/qcoin` -> `forum/qcoin` — 3 локальных импортов
...
- `components/i18n.js` — fan-in 32; основные потребители: `app/about/page.js`, `app/academy/AcademyExamBlock.js`, `app/academy/page.js`, `app/ads/GeoTargetingPicker.jsx`, `app/ads/home.js`, `app/ads/page.jsx`, `app/components/CryptoNewsLens.jsx`, `app/contact/page.js`
...
- `app/forum/features/profile/components/VipFlipBadge.jsx` — fan-in 6; основные потребители: `app/forum/features/dm/components/DmDialogRow.jsx`, `app/forum/features/dm/components/DmThreadHeader.jsx`, `app/forum/features/feed/components/PostHeaderMeta.jsx`, `app/forum/features/feed/components/TopicItem.jsx`, `app/forum/features/feed/components/UserRecommendationCard.jsx`, `app/forum/features/subscriptions/components/SubscriptionsPopover.jsx`
...
- `app/forum/features/media/utils/mediaLifecycleRuntime.js` — fan-in 5; основные потребители: `app/forum/features/dm/components/DmThreadMessageRow.jsx`, `app/forum/features/feed/components/PostCardBridge.jsx`, `app/forum/features/media/components/ComposerAttachmentPreview.jsx`, `app/forum/features/media/components/ExternalVideoPlayer.jsx`, `app/forum/features/media/hooks/useForumMediaCoordinator.js`
- `app/forum/shared/constants/media.js` — fan-in 5; основные потребители: `app/ads/home.js`, `app/forum/features/media/components/VideoLimitOverlay.jsx`, `app/forum/features/media/components/VideoTrimPopover.jsx`, `app/forum/features/media/utils/mediaRuntime.js`, `app/forum/ForumRoot.jsx`
...
- `lib/forumVideoTrim.js` — fan-in 4; основные потребители: `app/ads/home.js`, `app/forum/features/media/components/VideoTrimPopover.jsx`, `app/forum/features/media/utils/mediaRuntime.js`, `app/forum/ForumRoot.jsx`
