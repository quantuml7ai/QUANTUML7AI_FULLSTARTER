...
Сгенерировано автоматически: 2026-09-15T18:42:48.729Z
Исходных файлов в анализе: 1995
Локальных зависимостей: 3203
...
- `lib/ql7-support` -> `lib/ql7-support` — 933 локальных импортов
- `root` -> `lib/ql7-support` — 337 локальных импортов
...
- `forum/feed` -> `forum/feed` — 48 локальных импортов
- `api/metamarket` -> `api/metamarket` — 45 локальных импортов
- `components` -> `components` — 43 локальных импортов
- `lib/mongo` -> `lib/mongo` — 37 локальных импортов
- `root` -> `root` — 33 локальных импортов
...
- `root` -> `forum/feed` — 21 локальных импортов
- `api/forum` -> `lib/forum` — 20 локальных импортов
- `app/layout.js` -> `components` — 20 локальных импортов
...
- `forum/feed` -> `forum/profile` — 17 локальных импортов
- `root` -> `forum/media` — 16 локальных импортов
...
- `forum/dm` -> `forum/profile` — 13 локальных импортов
...
- `forum/ui` -> `forum/media` — 11 локальных импортов
...
- `lib/ql7-support/config/behaviorManifest.js` — fan-in 30; основные потребители: `lib/ql7-support/entryGreetingLexicon.js`, `lib/ql7-support/eventNotificationCatalog.js`, `lib/ql7-support/events.js`, `lib/ql7-support/evidencePolicy.js`, `lib/ql7-support/knowledge/academy/academyKnowledgeAdapter.js`, `lib/ql7-support/knowledge/knowledgeGraph.js`, `lib/ql7-support/language/humanVariationPrimitives.js`, `lib/ql7-support/language/languageVariantBank.js`
...
- `tests/support/projectSurface.js` — fan-in 17; основные потребители: `tests/contracts/metamarket/metamarket-contracts.test.js`, `tests/contracts/project/api-route-contracts.test.js`, `tests/contracts/project/app-entry-contracts.test.js`, `tests/contracts/project/canonical-human-identity-contract.test.js`, `tests/contracts/project/economic-runtime-hardening-contract.test.js`, `tests/contracts/project/forum-feed-empty-state.contract.test.js`, `tests/contracts/project/forum-hook-contracts.test.js`, `tests/contracts/project/forum-inbox-replies-autoload.contract.test.js`
...
- `lib/ql7-support/conversation/conversationMemoryGraph.js` — fan-in 12; основные потребители: `lib/ql7-support/conversation/memoryCompactor.js`, `lib/ql7-support/conversation/memoryConflictResolver.js`, `lib/ql7-support/conversation/memoryStore.js`, `lib/ql7-support/conversation/persistentMemoryProjection.js`, `lib/ql7-support/conversation/semanticContext.js`, `lib/ql7-support/runtime/canonicalContext.js`, `lib/ql7-support/runtime/executeTurn.js`, `lib/ql7-support/runtime/productionTurn.js`
...
- `app/forum/features/profile/hooks/useVipFlag.js` — fan-in 11; основные потребители: `app/forum/features/dm/components/DmDialogRow.jsx`, `app/forum/features/dm/components/DmThreadHeader.jsx`, `app/forum/features/dm/components/DmThreadMessageRow.jsx`, `app/forum/features/dm/hooks/useDmVipBatchProbe.js`, `app/forum/features/feed/components/ForumPostCard.jsx`, `app/forum/features/feed/components/TopicItem.jsx`, `app/forum/features/feed/hooks/useForumSyncLoop.js`, `app/forum/features/media/hooks/useForumVideoFeedRuntime.js`
