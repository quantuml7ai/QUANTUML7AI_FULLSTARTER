...
describe('QL7 Support canonical contracts', () => {
  ...
  it('declares 32 locales, semantic banks and 160 SVG assets', () => {
    ...
    expect(QL7_SUPPORT_RUNTIME_VERSION).toBe('18.0.0')
    ...
    expect(QL7_SUPPORT_BEHAVIOR_MANIFEST.rules.learningGovernance).toContain('versioned-export-rollback-no-production-online-learning')
