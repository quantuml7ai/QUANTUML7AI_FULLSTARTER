...
describe('QL7 Support Planetary AI V5 architecture contracts', () => {
  test('keeps immutable dependency manifests unchanged', () => {
    expect(sha256('package.json')).toBe('af1cb56ccf4c0d797e26c3fa86818ffede4412f6432429eda2c55b3c7f2ddb95')
    expect(sha256('pnpm-lock.yaml')).toBe('1d2f16ca02bfbb5baa2367592711ee0281f9866f2d0d48612a1d337f06a16d53')
  })
