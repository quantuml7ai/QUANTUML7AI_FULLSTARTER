...
describe('Exchange AI Box premium workbench contracts', () => {
  test('replaces the old split selector/quota/AI panels with one workbench', () => {
    ...
    expect(workbench).toContain("import ViewportAnimatedImage from '../../../components/visual-runtime/ViewportAnimatedImage'")
    expect(workbench).toContain('<ViewportAnimatedImage')
    expect(workbench).toContain('animatedSrc="/ai/ai.gif"')
    expect(workbench).not.toContain('src="/ai/ai.gif"')
  })
