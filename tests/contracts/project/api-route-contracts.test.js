...
describe('API route contracts', () => {
  ...
  it('keeps wallet sessions bound to the latest account token and hard logout cleanup', () => {
    ...
    expect(authNav).toContain('WALLET_SESSION_SILENT_REVERIFY_MIN_MS')
    ...
    expect(authNav).toContain('verifySession({ silent: true, minAgeMs: WALLET_SESSION_SILENT_REVERIFY_MIN_MS })')
