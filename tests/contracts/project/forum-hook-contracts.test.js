...
describe('Forum hook contracts', () => {
  ...
  it('keeps front-camera video mirroring metadata wired through fullscreen preview and safe upload fallback', () => {
    ...
    expect(mediaConstantsSource).toContain('FORUM_VIDEO_MAX_BYTES = 500 * 1024 * 1024')
    ...
    expect(composerAttachmentsSource).toContain('setMediaPct?.(100)')
    expect(progressBarSource).toContain('const isReady =')
    expect(progressBarSource).toContain('cmbReadyIcon')
    expect(progressBarSource).toContain('data-ready={isReady ?')
  })
