...
describe('Forum hook contracts', () => {
  ...
  it('keeps front-camera video mirroring metadata wired through fullscreen preview and safe upload fallback', () => {
    ...
    expect(composerPreviewSource).toContain('enableVideoControlsOnTap')
    ...
    expect(forumStylesSource).toContain('.attachPreviewRow video[data-front-camera-mirror="1"]::-webkit-media-controls-panel')
    expect(forumStylesSource).toContain('.voPreviewVideo[data-front-camera-mirror="1"]::-webkit-media-controls-panel')
    expect(forumStylesSource).toContain('.dmMediaBox[data-kind="video"] video[data-front-camera-mirror="1"]::-webkit-media-controls-panel')
    expect(forumStylesSource).toContain('.dmMediaBox[data-kind="video"] > video[data-front-camera-mirror="1"]::-webkit-media-controls-panel')
