...
import { buildQl7SupportCardV3 } from '../../../lib/ql7-support/cardSchemaV3.js'

function choiceCard() {
  return buildQl7SupportCardV3({
...
describe('QL7 Support V11.4 emotional and choice card surface', () => {
