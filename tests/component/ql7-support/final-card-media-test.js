...
import { buildQl7SupportCard, validateQl7SupportCard } from '../../../lib/ql7-support/cardSchema.js'
...
describe('QL7 Support V7 premium cards and shared media', () => {
  ...
  test('injects the exact ordinary-DM player stack into ordinary and Support media', () => {
    ...
    expect(ordinary).toMatch(/import \{ NativeSafeVideoPlayer \} from ['"]\.\.\/\.\.\/media\/utils\/mediaLifecycleRuntime\.js['"]/u)
    expect(ordinary).toMatch(/import DmVoicePlayer from ['"]\.\/DmVoicePlayer\.jsx['"]/u)
