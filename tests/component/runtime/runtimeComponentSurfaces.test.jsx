...
const SURFACE_CASES = [
  ...
  ['components/AuthNavClient.jsx', ['auth:ok', 'ql7:wallet-runtime:mount', 'openWalletRuntime']],
  ['components/TopBar.js', ['AuthNavClient', 'LanguageSwitcher', 'nav-orbit']],
  ['components/ScrollTopPulse.js', ['DIR_SWITCH_PX', 'passive: true', 'appearTimerRef', 'clearTimeout']],
