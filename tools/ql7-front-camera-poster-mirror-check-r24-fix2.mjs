...
forbid(resolver, 'readCachedNativeVideoPoster', 'resolver_string_poster_cache_regression')
need(resolver, 'mirrorX: !!videoMetaToSend?.frontCameraMirror', 'resolver_persistent_mirror_missing')
need(sampler, 'mirrorX: context.mirrorX', 'sampler_persistent_mirror_missing')
need(sampler, 'createNativeVideoPosterFromCanvas({', 'sampler_same_session_poster_missing')

need(preview, 'pendingVideoPosterBlob', 'composer_preview_artifact_blob_missing')
forbid(preview, 'createNativeVideoPoster', 'composer_preview_second_decoder_present')
need(preview, 'frontCameraMirror={pendingVideoMirror}', 'composer_video_mirror_missing')
need(overlay, 'previewPosterBlob', 'overlay_artifact_blob_missing')
forbid(overlay, 'createNativeVideoPoster', 'overlay_second_decoder_present')
