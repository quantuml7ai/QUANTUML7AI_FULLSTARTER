...
function main() {
  ...
  lines.push(immutablePublic
    ? '- Локальные модульные импорты между `app`, `components`, `lib`, `tools`; `public/**` исключён как внешний immutable asset namespace и не участвует в dependency inventory.'
