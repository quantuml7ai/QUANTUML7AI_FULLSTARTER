...
function main() {
  ...
  lines.push("- `.ql7-backups/`, `.ql7-local-archive/`, `.ql7-tmp/`, `account-deletion-reports/`, `migration-reports/`, `mongo-migration-reports/` — локальные backup/report/evidence артефакты.")
  lines.push("")
  lines.push("## Охват")
  lines.push('')
