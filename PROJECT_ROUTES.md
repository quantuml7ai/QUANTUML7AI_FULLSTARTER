...
Сгенерировано автоматически: 2026-09-05T14:07:01.966Z
Всего route-aware файлов: 162
Пользовательских route-сущностей: 26
API-route сущностей: 136
...
- `/[lang]/trust-and-identity` — страница маршрута `/[lang]/trust-and-identity`; файл: `app/[lang]/trust-and-identity/page.js`; тип: `page`.
...
- `/contact` — layout маршрута `/contact`; файл: `app/contact/layout.js`; тип: `layout`.
...
- `/privacy` — layout маршрута `/privacy`; файл: `app/privacy/layout.js`; тип: `layout`.
...
- `/tma/auto` — layout маршрута `/tma/auto`; файл: `app/tma/auto/layout.js`; тип: `layout`.
- `/tma/auto` — страница маршрута `/tma/auto`; файл: `app/tma/auto/page.jsx`; тип: `page`.

### trust-and-identity

- `/trust-and-identity` — route handler маршрута `/trust-and-identity`; файл: `app/trust-and-identity/route.js`; тип: `route-handler`.
...
- `/api/account-restrictions/status` — API-эндпоинт `/api/account-restrictions/status`; файл: `app/api/account-restrictions/status/route.js`; тип: `api-route`.
...
- `/api/app-shell/config` — API-эндпоинт `/api/app-shell/config`; файл: `app/api/app-shell/config/route.js`; тип: `api-route`.

### api/battlecoin

- `/api/battlecoin/chat/events` — API-эндпоинт `/api/battlecoin/chat/events`; файл: `app/api/battlecoin/chat/events/route.js`; тип: `api-route`.
- `/api/battlecoin/chat/messages` — API-эндпоинт `/api/battlecoin/chat/messages`; файл: `app/api/battlecoin/chat/messages/route.js`; тип: `api-route`.
- `/api/battlecoin/chat/reaction` — API-эндпоинт `/api/battlecoin/chat/reaction`; файл: `app/api/battlecoin/chat/reaction/route.js`; тип: `api-route`.
...
- `/api/composer-safety/preview` — API-эндпоинт `/api/composer-safety/preview`; файл: `app/api/composer-safety/preview/route.js`; тип: `api-route`.
...
- `/api/debug/ads/grant` — API-эндпоинт `/api/debug/ads/grant`; файл: `app/api/debug/ads/grant/route.js`; тип: `api-route`.
- `/api/debug/env` — API-эндпоинт `/api/debug/env`; файл: `app/api/debug/env/route.js`; тип: `api-route`.
- `/api/debug/forum-diag` — API-эндпоинт `/api/debug/forum-diag`; файл: `app/api/debug/forum-diag/route.js`; тип: `api-route`.
- `/api/debug/invoices` — API-эндпоинт `/api/debug/invoices`; файл: `app/api/debug/invoices/route.js`; тип: `api-route`.
- `/api/debug/qcoin/topup/grant` — API-эндпоинт `/api/debug/qcoin/topup/grant`; файл: `app/api/debug/qcoin/topup/grant/route.js`; тип: `api-route`.
- `/api/debug/redis` — API-эндпоинт `/api/debug/redis`; файл: `app/api/debug/redis/route.js`; тип: `api-route`.
- `/api/debug/redis/info` — API-эндпоинт `/api/debug/redis/info`; файл: `app/api/debug/redis/info/route.js`; тип: `api-route`.
- `/api/debug/vip` — API-эндпоинт `/api/debug/vip`; файл: `app/api/debug/vip/route.js`; тип: `api-route`.
- `/api/debug/vip/grant` — API-эндпоинт `/api/debug/vip/grant`; файл: `app/api/debug/vip/grant/route.js`; тип: `api-route`.
- `/api/debug/vip/migrate` — API-эндпоинт `/api/debug/vip/migrate`; файл: `app/api/debug/vip/migrate/route.js`; тип: `api-route`.
...
- `/api/dm/support-broadcast` — API-эндпоинт `/api/dm/support-broadcast`; файл: `app/api/dm/support-broadcast/route.js`; тип: `api-route`.
- `/api/dm/support-card-translate` — API-эндпоинт `/api/dm/support-card-translate`; файл: `app/api/dm/support-card-translate/route.js`; тип: `api-route`.
- `/api/dm/support-entry` — API-эндпоинт `/api/dm/support-entry`; файл: `app/api/dm/support-entry/route.js`; тип: `api-route`.
- `/api/dm/support-feedback` — API-эндпоинт `/api/dm/support-feedback`; файл: `app/api/dm/support-feedback/route.js`; тип: `api-route`.
- `/api/dm/support-learning-consent` — API-эндпоинт `/api/dm/support-learning-consent`; файл: `app/api/dm/support-learning-consent/route.js`; тип: `api-route`.
- `/api/dm/support-state` — API-эндпоинт `/api/dm/support-state`; файл: `app/api/dm/support-state/route.js`; тип: `api-route`.
- `/api/dm/support-worker` — API-эндпоинт `/api/dm/support-worker`; файл: `app/api/dm/support-worker/route.js`; тип: `api-route`.
...
- `/api/forum/feed/page` — API-эндпоинт `/api/forum/feed/page`; файл: `app/api/forum/feed/page/route.js`; тип: `api-route`.
- `/api/forum/inbox/replies/page` — API-эндпоинт `/api/forum/inbox/replies/page`; файл: `app/api/forum/inbox/replies/page/route.js`; тип: `api-route`.
- `/api/forum/media-feed/page` — API-эндпоинт `/api/forum/media-feed/page`; файл: `app/api/forum/media-feed/page/route.js`; тип: `api-route`.
...
- `/api/forum/search/page` — API-эндпоинт `/api/forum/search/page`; файл: `app/api/forum/search/page/route.js`; тип: `api-route`.
...
- `/api/forum/thread/locate` — API-эндпоинт `/api/forum/thread/locate`; файл: `app/api/forum/thread/locate/route.js`; тип: `api-route`.
- `/api/forum/thread/page` — API-эндпоинт `/api/forum/thread/page`; файл: `app/api/forum/thread/page/route.js`; тип: `api-route`.
- `/api/forum/topics/page` — API-эндпоинт `/api/forum/topics/page`; файл: `app/api/forum/topics/page/route.js`; тип: `api-route`.
...
- `/api/forum/user-posts/page` — API-эндпоинт `/api/forum/user-posts/page`; файл: `app/api/forum/user-posts/page/route.js`; тип: `api-route`.
...
- `/api/forum/user-topics/page` — API-эндпоинт `/api/forum/user-topics/page`; файл: `app/api/forum/user-topics/page/route.js`; тип: `api-route`.
...
- `/api/geo/session-touch` — API-эндпоинт `/api/geo/session-touch`; файл: `app/api/geo/session-touch/route.js`; тип: `api-route`.
...
- `/api/metamarket/buy` — API-эндпоинт `/api/metamarket/buy`; файл: `app/api/metamarket/buy/route.js`; тип: `api-route`.
- `/api/metamarket/collection` — API-эндпоинт `/api/metamarket/collection`; файл: `app/api/metamarket/collection/route.js`; тип: `api-route`.
- `/api/metamarket/gift` — API-эндпоинт `/api/metamarket/gift`; файл: `app/api/metamarket/gift/route.js`; тип: `api-route`.
- `/api/metamarket/my-collection` — API-эндпоинт `/api/metamarket/my-collection`; файл: `app/api/metamarket/my-collection/route.js`; тип: `api-route`.
- `/api/metamarket/owners` — API-эндпоинт `/api/metamarket/owners`; файл: `app/api/metamarket/owners/route.js`; тип: `api-route`.
- `/api/metamarket/quote` — API-эндпоинт `/api/metamarket/quote`; файл: `app/api/metamarket/quote/route.js`; тип: `api-route`.
- `/api/metamarket/sell` — API-эндпоинт `/api/metamarket/sell`; файл: `app/api/metamarket/sell/route.js`; тип: `api-route`.
- `/api/metamarket/state` — API-эндпоинт `/api/metamarket/state`; файл: `app/api/metamarket/state/route.js`; тип: `api-route`.
- `/api/metamarket/token-history` — API-эндпоинт `/api/metamarket/token-history`; файл: `app/api/metamarket/token-history/route.js`; тип: `api-route`.

### api/metastudio

- `/api/metastudio/register` — API-эндпоинт `/api/metastudio/register`; файл: `app/api/metastudio/register/route.js`; тип: `api-route`.

### api/pay

- `/api/pay/create` — API-эндпоинт `/api/pay/create`; файл: `app/api/pay/create/route.js`; тип: `api-route`.
- `/api/pay/qcoin-purchase` — API-эндпоинт `/api/pay/qcoin-purchase`; файл: `app/api/pay/qcoin-purchase/route.js`; тип: `api-route`.
...
- `/api/profile/delete-account` — API-эндпоинт `/api/profile/delete-account`; файл: `app/api/profile/delete-account/route.js`; тип: `api-route`.
...
- `/api/push/config` — API-эндпоинт `/api/push/config`; файл: `app/api/push/config/route.js`; тип: `api-route`.
- `/api/push/events` — API-эндпоинт `/api/push/events`; файл: `app/api/push/events/route.js`; тип: `api-route`.
- `/api/push/native/link` — API-эндпоинт `/api/push/native/link`; файл: `app/api/push/native/link/route.js`; тип: `api-route`.
- `/api/push/native/register` — API-эндпоинт `/api/push/native/register`; файл: `app/api/push/native/register/route.js`; тип: `api-route`.
- `/api/push/native/status` — API-эндпоинт `/api/push/native/status`; файл: `app/api/push/native/status/route.js`; тип: `api-route`.
- `/api/push/native/unlink` — API-эндпоинт `/api/push/native/unlink`; файл: `app/api/push/native/unlink/route.js`; тип: `api-route`.
- `/api/push/subscribe` — API-эндпоинт `/api/push/subscribe`; файл: `app/api/push/subscribe/route.js`; тип: `api-route`.
- `/api/push/sync` — API-эндпоинт `/api/push/sync`; файл: `app/api/push/sync/route.js`; тип: `api-route`.
- `/api/push/unsubscribe` — API-эндпоинт `/api/push/unsubscribe`; файл: `app/api/push/unsubscribe/route.js`; тип: `api-route`.
...
- `/api/qcoin/topup/cancel` — API-эндпоинт `/api/qcoin/topup/cancel`; файл: `app/api/qcoin/topup/cancel/route.js`; тип: `api-route`.
- `/api/qcoin/topup/create` — API-эндпоинт `/api/qcoin/topup/create`; файл: `app/api/qcoin/topup/create/route.js`; тип: `api-route`.
- `/api/qcoin/topup/webhook` — API-эндпоинт `/api/qcoin/topup/webhook`; файл: `app/api/qcoin/topup/webhook/route.js`; тип: `api-route`.
...
- `/api/wallet-session` — API-эндпоинт `/api/wallet-session`; файл: `app/api/wallet-session/route.js`; тип: `api-route`.
