...
Сгенерировано автоматически: 2026-09-15T18:42:52.166Z
Файлов в реестре: 3468
...
- app/ — Основной каталог Next.js App Router: страницы, layout и API.
  ...
  - ads/ — Страницы и модули рекламного раздела.
    ...
    - home.js — JS-файл home сегмента ads. Связи: импортирует app/ads/AdsGeoTargetingPortal.jsx, forum/features/media/services/moderatePreparedVideoForUpload.js, forum/features/media/services/uploadR2MediaFile.js; используется в app/ads/page.jsx.
  ...
  - api/ — Серверные API-маршруты и их внутренние хелперы.
    ...
    - battlecoin/ — Каталог battlecoin.
      ...
      - state/ — Каталог state.
        - route.js — API-route battlecoin/state для серверной логики Next.js. Связи: импортирует lib/mongo/battlecoin-primary.cjs, lib/runtime/routeTelemetry.js, lib/subscriptions.js.
    - brain/ — Каталог brain.
    ...
    - forum/ — Серверный контур форума: снапшоты, мутации, модерация, upload.
      ...
      - feed/ — Каталог feed.
        - page/ — Каталог page.
          - route.js — API-route forum/feed/page для серверной логики Next.js. Связи: импортирует lib/forum/forum-server-page-reader.cjs, lib/runtime/routeTelemetry.js.
      - inbox/ — Каталог inbox.
      ...
      - media-feed/ — Каталог media-feed.
        - page/ — Каталог page.
          - route.js — API-route forum/media-feed/page для серверной логики Next.js. Связи: импортирует lib/forum/forum-server-page-reader.cjs, lib/runtime/routeTelemetry.js.
      ...
      - subs/ — Каталог subs.
        ...
        - list/ — Каталог list.
          - route.js — API-route forum/subs/list для серверной логики Next.js. Связи: импортирует app/api/forum/_db.js, app/api/forum/_utils.js, app/api/profile/_identity.js; используется в tests/unit/api/forum/subs-list.route.test.js.
    ...
    - profile/ — Серверные маршруты профиля, ника и аватара.
      ...
      - _officialStatus.js — Внутренний official Status для API-сегмента profile. Связи: используется в app/api/profile/user-popover/route.js, tests/unit/api/profile/official-status.test.js.
    - push/ — Каталог push.
      - config/ — Каталог config.
  ...
  - components/ — Локальные компоненты верхнего уровня внутри app.
    - CryptoNewsLens.jsx — JSX-файл Crypto News Lens сегмента components. Связи: импортирует components/i18n.js, components/visual-runtime/TypewriterText.jsx, lib/visual-runtime/visualActivityRegistry.js; используется в app/page.js.
  ...
  - exchange/ — Страницы/виджеты exchange-раздела.
    - ai-box/ — Каталог ai-box.
      - AIWorkbench.jsx — JSX-файл AIWorkbench сегмента exchange/ai-box. Связи: импортирует components/i18n.js, components/visual-runtime/TypewriterText.jsx, components/visual-runtime/ViewportAnimatedImage.jsx; используется в app/exchange/page.js.
    ...
    - battle-chat/ — Каталог battle-chat.
      ...
      - useBattleChat.js — JS-файл use Battle Chat сегмента exchange/battle-chat. Связи: импортирует app/exchange/battle-chat/battleChatClient.js, lib/authActionGateClient.js; используется в app/exchange/battle-chat/BattleChat.jsx, tests/component/exchange/BattleCoinMarketRuntime.test.jsx.
    - BattleCoin.jsx — JSX-файл Battle Coin сегмента exchange. Связи: импортирует app/exchange/battle-chat/BattleChat.jsx, components/QuantumWalletLaunchIcon.jsx, components/i18n.js; используется в app/exchange/page.js, tests/component/exchange/BattleCoinMarketRuntime.test.jsx.
  ...
  - forum/ — Домен форума и мессенджера.
    ...
    - features/ — Feature-oriented слой форума.
      ...
      - dm/ — Подсистема Quantum Messenger / DM.
        - components/ — Каталог слоя компоненты внутри feature dm.
          ...
          - DmThreadLoadMore.jsx — UI-компонент Dm Thread Load More домена DM/мессенджера. Связи: используется в forum/features/dm/components/DmMessagesPane.jsx, tests/component/forum/runtime-stability-sentinel.component.test.jsx.
        ...
        - hooks/ — Каталог слоя хуки внутри feature dm.
          ...
          - useDmVipBatchProbe.js — Хук use Dm Vip Batch Probe домена DM/мессенджера. Связи: импортирует forum/features/profile/hooks/useVipFlag.js; используется в forum/features/dm/hooks/useForumDmRuntime.js.
      ...
      - feed/ — Подсистема ленты, тем, постов и композера.
        - components/ — Каталог слоя компоненты внутри feature feed.
          ...
          - LoadMoreSentinel.jsx — UI-компонент Load More Sentinel домена ленты/тем/постов. Связи: используется в forum/ForumRoot.jsx, forum/features/media/components/VideoFeedPane.jsx, tests/component/forum/runtime-stability-sentinel.component.test.jsx.
        ...
        - hooks/ — Каталог слоя хуки внутри feature feed.
          ...
          - useForumDeepLinkFlow.js — Хук use Forum Deep Link Flow домена ленты/тем/постов. Связи: импортирует forum/features/feed/constants/deeplink.js, forum/features/feed/utils/transientProjectionRetention.js, forum/shared/hooks/useEvent.js; используется в forum/features/feed/hooks/useForumFeedRuntime.js.
          ...
          - useForumMutationQueue.js — Хук use Forum Mutation Queue домена ленты/тем/постов. Связи: импортирует forum/features/feed/utils/snapshotTransforms.js; используется в forum/features/feed/hooks/useForumDataRuntime.js, tests/integration/forum/features/feed/hooks/useUserRecommendationsRail.test.jsx.
          ...
          - useForumSyncLoop.js — Хук use Forum Sync Loop домена ленты/тем/постов. Связи: импортирует forum/features/feed/utils/postMerge.js, forum/features/profile/hooks/useVipFlag.js; используется в forum/features/feed/hooks/useForumDataRuntime.js.
          ...
          - useThreadPostsModel.js — Хук use Thread Posts Model домена ленты/тем/постов. Связи: используется в forum/features/feed/hooks/useForumFeedRuntime.js, tests/integration/forum/features/feed/hooks/useThreadPostsModel.branch.test.jsx, tests/integration/forum/features/feed/hooks/useUserRecommendationsRail.test.jsx.
        ...
        - utils/ — Каталог слоя утилиты внутри feature feed.
          ...
          - postMerge.js — Утилита post Merge домена ленты/тем/постов. Связи: используется в forum/features/dm/hooks/useForumDmRuntime.js, forum/features/feed/hooks/useForumSyncLoop.js, forum/features/feed/hooks/usePublishedPostsModel.js.
          ...
          - transientProjectionRetention.js — Утилита transient Projection Retention домена ленты/тем/постов. Связи: импортирует forum/features/feed/utils/postMerge.js; используется в forum/features/dm/hooks/useForumDmRuntime.js, forum/features/feed/hooks/useForumDataRuntime.js, forum/features/feed/hooks/useForumDeepLinkFlow.js.
      - geo/ — Каталог geo.
      ...
      - media/ — Подсистема медиа, плееров и preview.
        - components/ — Каталог слоя компоненты внутри feature media.
          ...
          - VideoFeedPane.jsx — UI-компонент Video Feed Pane домена медиа. Связи: импортирует forum/features/feed/components/LoadMoreSentinel.jsx, forum/features/feed/components/UserRecommendationsRail.jsx, forum/features/profile/utils/profileCache.js; используется в forum/features/feed/components/TopicsOrPanelsSwitch.jsx, tests/component/forum/runtime-stability-sentinel.component.test.jsx.
          ...
          - VideoMedia.jsx — UI-компонент Video Media домена медиа. Связи: импортирует lib/forumVideoPosterPresentation.js; используется в forum/features/media/utils/mediaLifecycleRuntime.js.
        ...
        - services/ — Каталог слоя сервисы внутри feature media.
          - moderatePreparedVideoForUpload.js — Сервис moderate Prepared Video For Upload домена медиа. Связи: импортирует forum/features/moderation/utils/http.js, lib/nativeVideoPoster.js; используется в app/ads/home.js, forum/features/media/hooks/useForumComposerAttachments.js, forum/features/media/services/uploadR2MediaFile.js.
          ...
          - uploadR2MediaFile.js — Сервис upload R2 Media File домена медиа. Связи: импортирует forum/features/media/services/moderatePreparedVideoForUpload.js, lib/forumClientVideoOptimizer.js, lib/videoPipelineProgress.js; используется в app/ads/home.js, forum/features/media/services/resolveComposerMediaPayload.js, tests/integration/forum/media/clientVideoOptimizerPaperclip.test.jsx.
        - utils/ — Каталог слоя утилиты внутри feature media.
          ...
          - mediaStatePolicy.js — Утилита media State Policy домена медиа. Связи: используется в forum/features/media/hooks/useForumMediaCoordinator.js, tests/unit/forum/media/mediaStatePolicy.test.js.
      ...
      - profile/ — Подсистема профиля, about, VIP и popover.
        - components/ — Каталог слоя компоненты внутри feature profile.
          ...
          - UserInfoPopover.jsx — UI-компонент User Info Popover домена профиля/VIP. Связи: импортирует forum/features/profile/utils/profileCache.js, forum/features/subscriptions/components/FollowersCounterInline.jsx, forum/shared/api/translate.js; используется в forum/features/ui/components/ForumOverlayStack.jsx, components/MetaMarket.jsx.
      ...
      - subscriptions/ — Подсистема подписок/соцграфа.
        - components/ — Каталог слоя компоненты внутри feature subscriptions.
          ...
          - SubscriptionsPopover.jsx — UI-компонент Subscriptions Popover домена подписок. Связи: импортирует forum/features/profile/components/AvatarEmoji.jsx, forum/features/profile/components/VipFlipBadge.jsx, forum/features/profile/hooks/useVipFlag.js; используется в forum/features/ui/components/ForumOverlayStack.jsx, components/MetaMarket.jsx, tests/component/forum/features/subscriptions/SubscriptionsPopover.test.jsx.
      ...
      - ui/ — Общие UI-узлы и проп-бандлы форума.
        - components/ — Каталог слоя компоненты внутри feature ui.
          ...
          - ForumAdSlot.jsx — UI-компонент Forum Ad Slot домена форумного UI. Связи: импортирует forum/ForumAds.js, forum/features/media/utils/externalVideoBridge.js; используется в forum/ForumRoot.jsx.
          ...
          - ForumSearchSortControls.jsx — UI-компонент Forum Search Sort Controls домена форумного UI. Связи: импортирует forum/features/feed/utils/transientProjectionRetention.js, forum/features/media/utils/mediaLinks.js, forum/features/profile/components/AvatarEmoji.jsx; используется в forum/ForumHeaderPanel.jsx.
    ...
    - styles/ — Стили форума и их сборка.
      ...
      - ForumStyles.jsx — Файл стилевого слоя форума: Forum Styles. Связи: используется в forum/ForumLayout.jsx, components/MetaMarket.jsx.
    ...
    - ForumAds.js — Форумная интеграция рекламных/промо-блоков. Связи: импортирует components/i18n.js, components/visual-runtime/ViewportAnimatedImage.jsx, components/visual-runtime/useRenderManagedScope.js; используется в app/ads.js, forum/ForumRoot.jsx, forum/features/ui/components/ForumAdSlot.jsx.
...
- components/ — Общие React-компоненты всего проекта.
  ...
  - AndroidChromiumVideoCanvas.jsx — Общий React-компонент Android Chromium Video Canvas, используемый вне одного домена. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
  ...
  - GlobalMediaVisibilityRuntime.jsx — Общий React-компонент Global Media Visibility Runtime, используемый вне одного домена. Связи: используется в app/layout.js.
  ...
  - MetaMarket.jsx — Общий React-компонент Meta Market, используемый вне одного домена. Связи: импортирует forum/features/profile/components/AvatarEmoji.jsx, forum/features/profile/components/UserInfoPopover.jsx, forum/features/subscriptions/components/SubscriptionsPopover.jsx; используется в components/MetaMarketHost.jsx.
  ...
  - QCoinDropFX.jsx — Общий React-компонент QCoin Drop FX, используемый вне одного домена. Связи: импортирует lib/videoPipelineProgress.js; используется в app/layout.js, components/QCoinDropFXGate.jsx.
  ...
  - ScreenWakeLockRuntime.jsx — Общий React-компонент Screen Wake Lock Runtime, используемый вне одного домена. Связи: используется в app/layout.js.
...
- docs/ — Каталог docs.
  ...
  - ql7-support-deterministic-production.md — Markdown-документ ql7 support deterministic production. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
...
- lib/ — Общие библиотеки, кеши, middleware-хелперы и инфраструктурные утилиты.
  ...
  - battlecoin/ — Каталог battlecoin.
    ...
    - battlecoin-market-runtime.js — Общая библиотека/утилита battlecoin market runtime инфраструктурного слоя. Связи: используется в app/exchange/BattleCoin.jsx.
  - brand/ — Каталог brand.
  ...
  - ql7-support/ — Каталог ql7-support.
    - calibration/ — Каталог calibration.
      - activeCalibration.js — Общая библиотека/утилита active Calibration инфраструктурного слоя. Связи: используется в lib/ql7-support/calibration/runtimeCalibration.js, tests/unit/ql7-support/deterministic-production-architecture.test.js.
      - calibrationManifest.js — Общая библиотека/утилита calibration Manifest инфраструктурного слоя. Связи: используется в lib/ql7-support/calibration/runtimeCalibration.js, lib/ql7-support/conversation/persistentMemoryProjection.js.
      - runtimeCalibration.js — Общая библиотека/утилита runtime Calibration инфраструктурного слоя. Связи: импортирует lib/ql7-support/calibration/activeCalibration.js, lib/ql7-support/calibration/calibrationManifest.js; используется в lib/ql7-support/semantics/deterministicUnderstandingCoordinator.js, tests/unit/ql7-support/deterministic-production-architecture.test.js.
    - cards/ — Каталог cards.
    ...
    - config/ — Каталог config.
      ...
      - productionRuntime.js — Общая библиотека/утилита production Runtime инфраструктурного слоя. Связи: используется в lib/ql7-support/semantics/deterministicUnderstandingCoordinator.js.
    ...
    - conversation/ — Каталог conversation.
      ...
      - memoryPrivacyPolicy.js — Общая библиотека/утилита memory Privacy Policy инфраструктурного слоя. Связи: используется в lib/ql7-support/conversation/persistentMemoryProjection.js.
      - memoryStore.js — Общая библиотека/утилита memory Store инфраструктурного слоя. Связи: импортирует lib/ql7-support/conversation/conversationMemoryGraph.js, lib/ql7-support/conversation/persistentMemoryProjection.js; используется в lib/ql7-support/runtime/deliveryCommitCoordinator.js, lib/ql7-support/server.js, tests/unit/ql7-support/deterministic-production-architecture.test.js.
      ...
      - persistentMemoryProjection.js — Общая библиотека/утилита persistent Memory Projection инфраструктурного слоя. Связи: импортирует lib/ql7-support/calibration/calibrationManifest.js, lib/ql7-support/conversation/conversationMemoryGraph.js, lib/ql7-support/conversation/memoryPrivacyPolicy.js; используется в lib/ql7-support/conversation/memoryStore.js, tests/unit/ql7-support/deterministic-production-architecture.test.js.
    ...
    - knowledge/ — Каталог knowledge.
      ...
      - retrieval/ — Каталог retrieval.
        ...
        - deterministicReranker.js — Общая библиотека/утилита deterministic Reranker инфраструктурного слоя. Связи: используется в lib/ql7-support/knowledge/retrieval/hybridRetriever.js.
        ...
        - hybridRetriever.js — Общая библиотека/утилита hybrid Retriever инфраструктурного слоя. Связи: импортирует lib/ql7-support/internal/text.js, lib/ql7-support/knowledge/retrieval/conflictResolver.js, lib/ql7-support/knowledge/retrieval/deterministicReranker.js; используется в lib/ql7-support/knowledge/openHumanKnowledgeRouter.js, lib/ql7-support/runtime/nativeIntelligencePlane.js.
        ...
        - neuralReranker.js — Общая библиотека/утилита neural Reranker инфраструктурного слоя. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
      ...
      - publicFigureCatalog.js — Общая библиотека/утилита public Figure Catalog инфраструктурного слоя. Связи: импортирует lib/ql7-support/internal/text.js; используется в lib/ql7-support/knowledge/publicFigureKnowledgeGraph.js, lib/ql7-support/knowledge/publicFigureRegistry.js, lib/ql7-support/simulation/scenarioCatalog.js.
    ...
    - language/ — Каталог language.
      ...
      - nativeBanks.js — Общая библиотека/утилита native Banks инфраструктурного слоя. Связи: импортирует lib/ql7-support/internal/text.js; используется в lib/ql7-support/inputPolicy.js, lib/ql7-support/nativeTranslationService.js, lib/ql7-support/presentation/badgePolicy.js.
      ...
      - supportSurfaceCopyRegistry.js — Общая библиотека/утилита support Surface Copy Registry инфраструктурного слоя. Связи: импортирует lib/ql7-support/language/locales/manifest.js; используется в lib/ql7-support/presentation/badgePolicy.js, lib/ql7-support/presentation/buildSupportSurface.js, tests/unit/ql7-support/late-directive-canonical.test.js.
    - learning/ — Каталог learning.
      ...
      - incidentCandidate.js — Общая библиотека/утилита incident Candidate инфраструктурного слоя. Связи: импортирует lib/ql7-support/internal/text.js.
    ...
    - neural/ — Каталог neural.
      ...
      - nativeCriticAdapter.js — Общая библиотека/утилита native Critic Adapter инфраструктурного слоя. Связи: импортирует lib/ql7-support/neural/criticContract.js, lib/ql7-support/neural/modelManifest.js.
      - nativeGenerationAdapter.js — Общая библиотека/утилита native Generation Adapter инфраструктурного слоя. Связи: импортирует lib/ql7-support/neural/generationContract.js, lib/ql7-support/neural/modelManifest.js.
      - nativeModelGateway.js — Общая библиотека/утилита native Model Gateway инфраструктурного слоя. Связи: импортирует lib/ql7-support/internal/text.js, lib/ql7-support/neural/modelManifest.js, lib/ql7-support/neural/modelReceipt.js; используется в lib/composer-safety/nativeSemanticAdapter.cjs, lib/ql7-support/neural/understandingCoordinator.js, lib/ql7-support/simulation/model/nativeModelOracleClient.js.
    ...
    - presentation/ — Каталог presentation.
      - badgePolicy.js — Общая библиотека/утилита badge Policy инфраструктурного слоя. Связи: импортирует lib/ql7-support/ecosystemCatalog.js, lib/ql7-support/language/nativeBanks.js, lib/ql7-support/language/supportSurfaceCopyRegistry.js; используется в lib/ql7-support/presentation/buildSupportSurface.js, tests/unit/ql7-support/material-runtime.test.js.
      ...
      - tableRegistry.js — Общая библиотека/утилита table Registry инфраструктурного слоя. Связи: импортирует lib/ql7-support/internal/text.js, lib/ql7-support/language/factPresentationLexicon.js, lib/ql7-support/language/nativeBanks.js; используется в lib/ql7-support/presentation/buildSupportSurface.js.
    ...
    - response/ — Каталог response.
      ...
      - humanNaturalRealizer.js — Общая библиотека/утилита human Natural Realizer инфраструктурного слоя. Связи: импортирует lib/ql7-support/internal/text.js, lib/ql7-support/response/botPhraseRegistry.js, lib/ql7-support/response/discoursePlanner.js; используется в lib/ql7-support/runtime/executeTurn.js.
    ...
    - semantics/ — Каталог semantics.
      ...
      - deterministicUnderstandingCoordinator.js — Общая библиотека/утилита deterministic Understanding Coordinator инфраструктурного слоя. Связи: импортирует lib/ql7-support/calibration/runtimeCalibration.js, lib/ql7-support/config/productionRuntime.js, lib/ql7-support/internal/text.js; используется в lib/ql7-support/runtime/canonicalContext.js, lib/ql7-support/runtime/productionTurn.js, tests/unit/ql7-support/deterministic-production-architecture.test.js.
    ...
    - simulation/ — Каталог simulation.
      ...
      - DeterministicContractOracle.js — Общая библиотека/утилита Deterministic Contract Oracle инфраструктурного слоя. Связи: импортирует lib/ql7-support/evidencePolicy.js; используется в lib/ql7-support/simulation/executeScenario.js.
      ...
      - independentOracle.js — Общая библиотека/утилита independent Oracle инфраструктурного слоя. Связи: импортирует lib/ql7-support/evidencePolicy.js, lib/ql7-support/internal/text.js, lib/ql7-support/response/critiqueResponse.js; используется в lib/ql7-support/simulation/factualSimulation.js.
    ...
    - telemetry/ — Каталог telemetry.
      - canonicalTelemetry.js — Общая библиотека/утилита canonical Telemetry инфраструктурного слоя. Связи: импортирует lib/ql7-support/cognitiveMemory.js, lib/ql7-support/personalityEngine.js, lib/ql7-support/runtimeCapabilityRegistry.js; используется в lib/ql7-support/server.js.
    ...
    - evidencePolicy.js — Общая библиотека/утилита evidence Policy инфраструктурного слоя. Связи: импортирует lib/ql7-support/config/behaviorManifest.js, lib/ql7-support/language/factPresentationLexicon.js; используется в lib/ql7-support/cards/cardPresentation.js, lib/ql7-support/diagnosticPresentation.js, lib/ql7-support/simulation/DeterministicContractOracle.js.
    ...
    - learningGovernance.js — Общая библиотека/утилита learning Governance инфраструктурного слоя. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
    - learningPipeline.js — Общая библиотека/утилита learning Pipeline инфраструктурного слоя. Связи: импортирует lib/ql7-support/learning/approvalReceipt.js, lib/ql7-support/learning/calibrationCandidateReceipt.js, lib/ql7-support/learning/datasetDeletion.js; используется в app/api/dm/support-feedback/route.js, tests/integration/ql7-support/premium-pipeline.test.js.
    ...
    - nativeTranslationService.js — Общая библиотека/утилита native Translation Service инфраструктурного слоя. Связи: импортирует lib/ql7-support/config/behaviorManifest.js, lib/ql7-support/language/nativeBanks.js; используется в app/api/dm/support-card-translate/route.js, lib/ql7-support/language/finalDeliveryLocalization.js, lib/ql7-support/language/nativeStructuredLocalization.js.
    - package.json — Манифест пакета, npm/pnpm-скрипты и зависимости. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
    ...
    - presentation.js — Общая библиотека/утилита presentation инфраструктурного слоя. Связи: импортирует lib/ql7-support/config/behaviorManifest.js; используется в forum/features/dm/components/Ql7SupportCard.js, lib/ql7-support/cards/cardPresentation.js.
  ...
  - visual-runtime/ — Каталог visual-runtime.
    ...
    - visualActivityRegistry.js — Общая библиотека/утилита visual Activity Registry инфраструктурного слоя. Связи: используется в app/components/CryptoNewsLens.jsx, components/MediaPipelineProgress.jsx, components/visual-runtime/GlobalVisualActivityRuntime.jsx.
  ...
  - nativeVideoPoster.js — Общая библиотека/утилита native Video Poster инфраструктурного слоя. Связи: используется в forum/features/media/services/moderatePreparedVideoForUpload.js, tests/unit/forum/nativeVideoPosterPolicy.test.js.
...
- public/ — Статические ассеты, доступные по публичным URL.
  ...
  - status/ — Подкаталог статических ассетов public/status.
    - official.png — PNG-ассет из public/status; статический ассет проекта. Связи: подключается через public URL/стили; прямые модульные импорты обычно не используются.
  ...
  - youtube/ — Подкаталог статических ассетов public/youtube.
    - play.webp — WEBP-ассет из public/youtube; статический ассет проекта. Связи: подключается через public URL/стили; прямые модульные импорты обычно не используются.
  ...
  - favicon.ico — ICO-ассет из public/; статический ассет проекта. Связи: подключается через public URL/стили; прямые модульные импорты обычно не используются.
...
- tests/ — Каталог tests.
  - component/ — Каталог component.
    - exchange/ — Каталог exchange.
      - BattleCoinMarketRuntime.test.jsx — JSX-файл Battle Coin Market Runtime.test. Связи: импортирует app/exchange/BattleCoin.jsx, app/exchange/battle-chat/useBattleChat.js.
    - forum/ — Каталог forum.
      - features/ — Каталог features.
        ...
        - subscriptions/ — Каталог subscriptions.
          - SubscriptionsPopover.test.jsx — JSX-файл Subscriptions Popover.test. Связи: импортирует forum/features/subscriptions/components/SubscriptionsPopover.jsx.
      - runtime-stability-sentinel.component.test.jsx — JSX-файл runtime stability sentinel.component.test. Связи: импортирует forum/features/dm/components/DmThreadLoadMore.jsx, forum/features/feed/components/LoadMoreSentinel.jsx, forum/features/feed/components/PostFxLayer.jsx.
    - ql7-support/ — Каталог ql7-support.
  ...
  - contracts/ — Каталог contracts.
    ...
    - project/ — Каталог project.
      ...
      - deep-translate-typewriter.contract.test.js — JS-файл deep translate typewriter.contract.test. Связи: импортирует components/visual-runtime/TypewriterText.jsx.
      ...
      - forum-composer-voice-timer-overlay.contract.test.js — JS-файл forum composer voice timer overlay.contract.test. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
      - forum-feed-empty-state.contract.test.js — JS-файл forum feed empty state.contract.test. Связи: импортирует tests/support/projectSurface.js.
      - forum-hook-contracts.test.js — JS-файл forum hook contracts.test. Связи: импортирует tests/support/projectSurface.js.
      - forum-inbox-replies-autoload.contract.test.js — JS-файл forum inbox replies autoload.contract.test. Связи: импортирует tests/support/projectSurface.js.
      ...
      - forum-subs-list-single-read.contract.test.js — JS-файл forum subs list single read.contract.test. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
      ...
      - ql7-support-deterministic-production.contract.test.js — JS-файл ql7 support deterministic production.contract.test. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
      ...
      - user-info-official-status.contract.test.js — JS-файл user info official status.contract.test. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
      - user-info-popover-layout.contract.test.js — JS-файл user info popover layout.contract.test. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
  ...
  - integration/ — Каталог integration.
      ...
      - features/ — Каталог features.
        - feed/ — Каталог feed.
          - hooks/ — Каталог hooks.
            ...
            - useUserRecommendationsRail.test.jsx — JSX-файл use User Recommendations Rail.test. Связи: импортирует forum/features/feed/hooks/useForumMutationQueue.js, forum/features/feed/hooks/usePostMediaTextModel.js, forum/features/feed/hooks/usePublishedPostsModel.js.
        - profile/ — Каталог profile.
          - useVipFlagBatching.test.jsx — JSX-файл use Vip Flag Batching.test. Связи: импортирует forum/features/profile/hooks/useVipFlag.js.
      - media/ — Каталог media.
    ...
    - runtime/ — Каталог runtime.
      - runtimeGovernance.integration.test.js — JS-файл runtime Governance.integration.test. Связи: импортирует lib/walletSessionClient.js, src/shared/runtime/budgets/budgetEngine.js, src/shared/runtime/budgets/routeCapabilities.js.
    - visual-runtime/ — Каталог visual-runtime.
    ...
    - ql7-support-neural-production-parity.integration.test.js — JS-файл ql7 support neural production parity.integration.test. Связи: импортирует lib/ql7-support/runtime/productionTurn.js, lib/ql7-support/simulation/executeScenario.js.
  ...
  - unit/ — Каталог unit.
    ...
    - api/ — Каталог api.
      - forum/ — Каталог forum.
        - subs-list.route.test.js — JS-файл subs list.route.test. Связи: импортирует app/api/forum/subs/list/route.js.
      ...
      - profile/ — Каталог profile.
        - official-status.test.js — JS-файл official status.test. Связи: импортирует app/api/profile/_officialStatus.js.
        - user-popover.route.test.js — JS-файл user popover.route.test. Связи: импортирует app/api/profile/user-popover/route.js.
    - battlecoin/ — Каталог battlecoin.
      - battle-chat-validation.test.js — JS-файл battle chat validation.test. Связи: импортирует app/exchange/battle-chat/battleChatClient.js, lib/battlecoin/battle-chat-validation.cjs.
    - brand/ — Каталог brand.
    ...
    - forum/ — Каталог forum.
      ...
      - transientProjectionRetention.test.js — JS-файл transient Projection Retention.test. Связи: импортирует forum/features/feed/utils/postMerge.js, forum/features/feed/utils/transientProjectionRetention.js.
    ...
    - ql7-support/ — Каталог ql7-support.
      ...
      - deterministic-production-architecture.test.js — JS-файл deterministic production architecture.test. Связи: импортирует lib/ql7-support/calibration/activeCalibration.js, lib/ql7-support/calibration/runtimeCalibration.js, lib/ql7-support/conversation/conversationMemoryGraph.js.
    ...
    - runtime/ — Каталог runtime.
      - routeTelemetry.test.js — JS-файл route Telemetry.test. Связи: импортирует lib/runtime/routeTelemetry.js.
...
- tools/ — Локальные скрипты аудита, генерации и техобслуживания.
  ...
  - ql7-support-calibration-export.mjs — Локальный скрипт/инструмент ql7 support calibration export для аудита или техобслуживания. Связи: запускается вручную или из локального audit/workflow.
  - ql7-support-production-boundary.mjs — Локальный скрипт/инструмент ql7 support production boundary для аудита или техобслуживания. Связи: запускается вручную или из локального audit/workflow.
...
- .vercelignore — Служебный-файл . Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
...
- jsconfig.json — Алиасы и baseUrl проекта для JS/JSX. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
- lint ` — Служебный-файл lint `. Связи: явных локальных модульных связей не обнаружено или файл используется инфраструктурой/рантаймом.
